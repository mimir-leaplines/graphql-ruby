...
#   }).to_s
#
# source://jekyll//lib/jekyll.rb#42
module Jekyll
  class << self
    ...
    #
    # source://jekyll//lib/jekyll.rb#114
    ...
    #
    # source://jekyll//lib/jekyll.rb#101
    def env; end
    ...
    #
    # source://jekyll//lib/jekyll.rb#145
    def logger; end
    ...
    #
    # source://jekyll//lib/jekyll.rb#156
    ...
    #
    # source://jekyll//lib/jekyll.rb#174
    ...
    # Returns nothing
    #
    # source://jekyll//lib/jekyll.rb#133
    ...
    #
    # source://jekyll//lib/jekyll.rb#163
    def sites; end
  end
end

# source://jekyll//lib/jekyll/cache.rb#6
class Jekyll::Cache
  ...
  #
  # source://jekyll//lib/jekyll/cache.rb#62
  ...
  #
  # source://jekyll//lib/jekyll/cache.rb#77
  def [](key); end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/cache.rb#91
  def []=(key, value); end

  # Clear this particular cache
  #
  # source://jekyll//lib/jekyll/cache.rb#68
  def clear; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/cache.rb#115
  def delete(key); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/cache.rb#134
  ...
  #
  # source://jekyll//lib/jekyll/cache.rb#104
  def getset(key); end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/cache.rb#123
  def key?(key); end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/cache.rb#156
  ...
  class << self
    ...
    # Clear all caches
    #
    # source://jekyll//lib/jekyll/cache.rb#25
    def clear; end
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/cache.rb#50
    def delete_cache_files; end
  end
end
...
#
# source://jekyll//lib/jekyll/cleaner.rb#5
class Jekyll::Cleaner
  # @return [Cleaner] a new instance of Cleaner
  #
  # source://jekyll//lib/jekyll/cleaner.rb#9
  def initialize(site); end

  # Cleans up the site's destination directory
  #
  # source://jekyll//lib/jekyll/cleaner.rb#14
  def cleanup!; end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/cleaner.rb#7
  def site; end
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#41
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#96
  def keep_dirs; end
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#107
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#33
  ...
  # Returns a Set with the directory paths
  #
  # source://jekyll//lib/jekyll/cleaner.rb#68
  def new_dirs; end
  ...
  # Returns a Set with the file paths
  #
  # source://jekyll//lib/jekyll/cleaner.rb#58
  def new_files; end
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#24
  ...
  #
  # source://jekyll//lib/jekyll/cleaner.rb#75
  ...
  # Returns a Set with the file paths
  #
  # source://jekyll//lib/jekyll/cleaner.rb#88
  def replaced_files; end
end

# source://jekyll//lib/jekyll/cleaner.rb#6
Jekyll::Cleaner::HIDDEN_FILE_REGEX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/collection.rb#4
class Jekyll::Collection
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#14
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#131
  ...
  #   is stored on the filesystem.
  #
  # source://jekyll//lib/jekyll/collection.rb#117
  def directory; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#24
  def docs; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#6
  def docs=(_arg0); end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#76
  def entries; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#151
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/collection.rb#143
  def exists?; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#203
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#50
  def files; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#92
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#158
  def inspect; end

  # Returns the value of attribute label.
  #
  # source://jekyll//lib/jekyll/collection.rb#5
  def label; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#35
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#57
  def read; end
  ...
  #   is stored on the filesystem.
  #
  # source://jekyll//lib/jekyll/collection.rb#109
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#169
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#179
  def to_liquid; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#194
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/collection.rb#187
  def write?; end

  private

  # source://jekyll//lib/jekyll/collection.rb#213
  def container; end

  # source://jekyll//lib/jekyll/collection.rb#253
  def determine_sort_order(sort_key, apples, olives); end

  # source://jekyll//lib/jekyll/collection.rb#266
  def order_with_warning(sort_key, document, order); end

  # source://jekyll//lib/jekyll/collection.rb#217
  def read_document(full_path); end

  # source://jekyll//lib/jekyll/collection.rb#295
  ...
  # merged array.
  #
  # source://jekyll//lib/jekyll/collection.rb#276
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/collection.rb#30
  def respond_to_missing?(method, include_private = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/collection.rb#223
  def sort_docs!; end
  ...
  #
  # source://jekyll//lib/jekyll/collection.rb#235
  def sort_docs_by_key!; end
end

# source://jekyll//lib/jekyll/readers/collection_reader.rb#4
class Jekyll::CollectionReader
  # @return [CollectionReader] a new instance of CollectionReader
  #
  # source://jekyll//lib/jekyll/readers/collection_reader.rb#9
  def initialize(site); end

  # Returns the value of attribute content.
  #
  # source://jekyll//lib/jekyll/readers/collection_reader.rb#7
  def content; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/readers/collection_reader.rb#17
  def read; end
...
# source://jekyll//lib/jekyll/readers/collection_reader.rb#5
Jekyll::CollectionReader::SPECIAL_COLLECTIONS = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/command.rb#4
class Jekyll::Command
  class << self
    ...
    # Returns nothing
    #
    # source://jekyll//lib/jekyll/command.rb#53
    ...
    #
    # source://jekyll//lib/jekyll/command.rb#41
    ...
    # Returns nothing
    #
    # source://jekyll//lib/jekyll/command.rb#17
    ...
    # Returns nothing
    #
    # source://jekyll//lib/jekyll/command.rb#27
    ...
    #
    # source://jekyll//lib/jekyll/command.rb#90
    def process_with_graceful_fail(cmd, options, *klass); end

    # A list of subclasses of Jekyll::Command
    #
    # source://jekyll//lib/jekyll/command.rb#7
    def subclasses; end
  end
end

# source://jekyll//lib/jekyll/commands/build.rb#4
module Jekyll::Commands; end

# source://jekyll//lib/jekyll/commands/build.rb#5
class Jekyll::Commands::Build < ::Jekyll::Command
  class << self
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/commands/build.rb#55
    def build(site, options); end

    # Create the Mercenary command for the Jekyll CLI for this Command
    #
    # source://jekyll//lib/jekyll/commands/build.rb#8
    def init_with_program(prog); end

    # Build your jekyll site
    # Continuously watch if `watch` is set to true in the config.
    #
    # source://jekyll//lib/jekyll/commands/build.rb#25
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/commands/build.rb#75
    def watch(site, options); end
  end
end

# source://jekyll//lib/jekyll/commands/clean.rb#5
class Jekyll::Commands::Clean < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/clean.rb#7
    def init_with_program(prog); end

    # source://jekyll//lib/jekyll/commands/clean.rb#20
    def process(options); end

    # source://jekyll//lib/jekyll/commands/clean.rb#33
    def remove(filename, checker_func: T.unsafe(nil)); end
  end
end

# source://jekyll//lib/jekyll/commands/doctor.rb#5
class Jekyll::Commands::Doctor < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/doctor.rb#68
    def conflicting_urls(site); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#60
    def deprecated_relative_permalinks(site); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#84
    def fsnotify_buggy?(_site); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#35
    def healthy?(site); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#7
    def init_with_program(prog); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#22
    def process(options); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#115
    def proper_site_url?(site); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#46
    def properly_gathered_posts?(site); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#101
    ...
    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#137
    def allow_used_permalink?(item); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#141
    def case_insensitive_urls(things, destination); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#126
    def destination_map(site); end

    # source://jekyll//lib/jekyll/commands/doctor.rb#167
    def url_absolute(url); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#148
    def url_exists?(url); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/doctor.rb#156
    def url_valid?(url); end
  end
end

# source://jekyll//lib/jekyll/commands/help.rb#5
class Jekyll::Commands::Help < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/help.rb#7
    def init_with_program(prog); end

    # source://jekyll//lib/jekyll/commands/help.rb#26
    def invalid_command(prog, cmd); end
  end
end

# source://jekyll//lib/jekyll/commands/new.rb#7
class Jekyll::Commands::New < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/new.rb#44
    def blank_template; end

    # source://jekyll//lib/jekyll/commands/new.rb#48
    def create_blank_site(path); end

    # source://jekyll//lib/jekyll/commands/new.rb#9
    def init_with_program(prog); end
    ...
    #
    # source://jekyll//lib/jekyll/commands/new.rb#64
    def initialized_post_name; end

    # @raise [ArgumentError]
    #
    # source://jekyll//lib/jekyll/commands/new.rb#24
    def process(args, options = T.unsafe(nil)); end

    # source://jekyll//lib/jekyll/commands/new.rb#57
    ...
    #
    # source://jekyll//lib/jekyll/commands/new.rb#138
    def after_install(path, options = T.unsafe(nil)); end

    # source://jekyll//lib/jekyll/commands/new.rb#152
    def bundle_install(path); end

    # source://jekyll//lib/jekyll/commands/new.rb#120
    def create_sample_files(path); end

    # source://jekyll//lib/jekyll/commands/new.rb#108
    def create_site(new_blog_path); end

    # source://jekyll//lib/jekyll/commands/new.rb#70
    def gemfile_contents; end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/commands/new.rb#116
    def preserve_source_location?(path, options); end

    # source://jekyll//lib/jekyll/commands/new.rb#130
    def scaffold_path; end

    # source://jekyll//lib/jekyll/commands/new.rb#126
    def site_template; end
  end
end

# source://jekyll//lib/jekyll/commands/new_theme.rb#7
class Jekyll::Commands::NewTheme < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/new_theme.rb#9
    def init_with_program(prog); end

    # source://jekyll//lib/jekyll/commands/new_theme.rb#22
    def process(args, opts); end
  end
end

# source://jekyll//lib/jekyll/commands/serve.rb#5
class Jekyll::Commands::Serve < ::Jekyll::Command
  class << self
    # source://jekyll//lib/jekyll/commands/serve.rb#61
    def init_with_program(prog); end

    # Returns the value of attribute mutex.
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#58
    def mutex; end

    # source://jekyll//lib/jekyll/commands/serve.rb#93
    ...
    # source://jekyll//lib/jekyll/commands/serve.rb#105
    def shutdown; end
    ...
    # ask us to do.
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#274
    def boot_or_detach(server, opts); end

    # source://jekyll//lib/jekyll/commands/serve.rb#253
    def default_url(opts); end

    # Make the stack verbose if the user requests it.
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#291
    ...
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#300
    def enable_ssl(opts); end

    # Recreate NondisclosureName under utf-8 circumstance
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#227
    def file_handler_opts; end

    # source://jekyll//lib/jekyll/commands/serve.rb#245
    def format_url(ssl_enabled, address, port, baseurl = T.unsafe(nil)); end

    # source://jekyll//lib/jekyll/commands/serve.rb#262
    def launch_browser(server, opts); end

    # source://jekyll//lib/jekyll/commands/serve.rb#352
    def mime_types; end

    # source://jekyll//lib/jekyll/commands/serve.rb#357
    def mime_types_charset; end

    # source://jekyll//lib/jekyll/commands/serve.rb#361
    def read_file(source_dir, file_path); end

    # source://jekyll//lib/jekyll/commands/serve.rb#142
    def register_reload_hooks(opts); end

    # source://jekyll//lib/jekyll/commands/serve.rb#236
    ...
    #
    #
    # source://jekyll//lib/jekyll/commands/serve.rb#179
    def setup(destination); end

    # source://jekyll//lib/jekyll/commands/serve.rb#323
    def start_callback(detached); end

    # source://jekyll//lib/jekyll/commands/serve.rb#215
    def start_up_webrick(opts, destination); end

    # source://jekyll//lib/jekyll/commands/serve.rb#337
    def stop_callback(detached); end

    # source://jekyll//lib/jekyll/commands/serve.rb#113
    def validate_options(opts); end

    # source://jekyll//lib/jekyll/commands/serve.rb#194
    def webrick_opts(opts); end
  end
end

# source://jekyll//lib/jekyll/configuration.rb#4
class Jekyll::Configuration < ::Hash
  # source://jekyll//lib/jekyll/configuration.rb#230
  def add_default_collections; end

  # source://jekyll//lib/jekyll/configuration.rb#262
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#141
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#214
  def csv_to_array(csv); end

  # source://jekyll//lib/jekyll/configuration.rb#100
  def get_config_value_with_override(config_key, override); end

  # source://jekyll//lib/jekyll/configuration.rb#113
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#165
  ...
  # configuration files
  #
  # source://jekyll//lib/jekyll/configuration.rb#191
  def read_config_files(files); end

  # source://jekyll//lib/jekyll/configuration.rb#123
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#109
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#96
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#221
  def validate; end

  # source://jekyll//lib/jekyll/configuration.rb#118
  ...
  # source://jekyll//lib/jekyll/configuration.rb#286
  ...
  #
  # source://jekyll//lib/jekyll/configuration.rb#302
  def check_plugins(config); end

  # source://jekyll//lib/jekyll/configuration.rb#282
  ...
  class << self
    ...
    #
    # source://jekyll//lib/jekyll/configuration.rb#87
...
class Jekyll::Converter < ::Jekyll::Plugin
  ...
  #
  # source://jekyll//lib/jekyll/converter.rb#36
  ...
  #
  # source://jekyll//lib/jekyll/converter.rb#43
  ...
  #
  # source://jekyll//lib/jekyll/converter.rb#50
  ...
  class << self
    ...
    # Returns the String prefix.
    #
    # source://jekyll//lib/jekyll/converter.rb#12
    ...
    # Returns the String suffix.
    #
    # source://jekyll//lib/jekyll/converter.rb#26
    def highlighter_suffix(highlighter_suffix = T.unsafe(nil)); end

    # source://jekyll//lib/jekyll/plugin.rb#24
    def inherited(const_); end
  end
end

# source://jekyll//lib/jekyll/converters/identity.rb#4
...
#
# source://jekyll//lib/jekyll/converters/identity.rb#7
class Jekyll::Converters::Identity < ::Jekyll::Converter
  ...
  #
  # source://jekyll//lib/jekyll/converters/identity.rb#36
  ...
  #
  # source://jekyll//lib/jekyll/converters/identity.rb#18
  ...
  #
  # source://jekyll//lib/jekyll/converters/identity.rb#27
...
# For more info on converters see https://jekyllrb.com/docs/plugins/converters/
#
# source://jekyll//lib/jekyll/converters/markdown.rb#7
class Jekyll::Converters::Markdown < ::Jekyll::Converter
  ...
  # Returns a String of the converted content.
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#83
  def convert(content); end

  # source://jekyll//lib/jekyll/converters/markdown.rb#90
  ...
  #
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#35
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#65
  def matches(ext); end
  ...
  # Returns The String output file extension.
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#74
  def output_ext(_ext); end

  # source://jekyll//lib/jekyll/converters/markdown.rb#12
  def setup; end
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#55
  ...
  # Returns an array of symbols.
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#48
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/converters/markdown.rb#108
  def custom_class_allowed?(parser_name); end

  # source://jekyll//lib/jekyll/converters/markdown.rb#96
...
# source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#74
class Jekyll::Converters::Markdown::KramdownParser
  # @return [KramdownParser] a new instance of KramdownParser
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#84
  def initialize(config); end

  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#108
  def convert(content); end
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#99
  def setup; end
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#140
  def highlighter; end

  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#121
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#178
  def modernize_coderay_config; end

  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#161
  def strip_coderay_prefix(hash); end
end

# source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#75
...
class Jekyll::Converters::Scss < ::Jekyll::Converter
  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#52
  def associate_page(page); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#159
  def convert(content); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#65
  def dissociate_page(page); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#88
  def jekyll_sass_configuration; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#76
  def matches(ext); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#80
  def output_ext(_ext); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#84
  def safe?; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#145
  def sass_configs; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#102
  def sass_dir; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#117
  def sass_dir_relative_to_site_source; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#123
  def sass_load_paths; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#108
  def sass_style; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#98
  def syntax; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#113
  def user_sass_load_paths; end

  private

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#183
  def associate_page_failed?; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#266
  def file_url_from_path(path); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#244
  def generate_source_map_page(source_map); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#231
  def process_source_map(source_map); end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#271
  def quiet_deps_option; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#188
  def sass_file_url; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#181
  def sass_page; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#220
  def sass_source_root; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#258
  def site; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#262
  def site_source; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#213
  def source_map_page; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#252
  def source_mapping_url; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#199
  def sourcemap_option; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#206
  def sourcemap_required?; end

  # source://jekyll-sass-converter/3.0.0/lib/jekyll/converters/scss.rb#276
...
# For more info on converters see https://jekyllrb.com/docs/plugins/converters/
#
# source://jekyll//lib/jekyll/converters/smartypants.rb#24
class Jekyll::Converters::SmartyPants < ::Jekyll::Converter
  # @return [SmartyPants] a new instance of SmartyPants
  #
  # source://jekyll//lib/jekyll/converters/smartypants.rb#28
  def initialize(config); end
  ...
  # Returns a String of the converted content.
  #
  # source://jekyll//lib/jekyll/converters/smartypants.rb#58
  def convert(content); end
  ...
  # Returns true if it matches, false otherwise.
  #
  # source://jekyll//lib/jekyll/converters/smartypants.rb#40
  def matches(_ext); end
  ...
  # Returns The String output file extension.
  #
  # source://jekyll//lib/jekyll/converters/smartypants.rb#49
  def output_ext(_ext); end
...
# source://jekyll//lib/jekyll/convertible.rb#18
module Jekyll::Convertible
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#235
  def [](property); end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#141
  def asset_file?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#155
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#96
  def converters; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/convertible.rb#205
  def do_layout(payload, layouts); end

  # returns the owner symbol for hook triggering
  #
  # source://jekyll//lib/jekyll/convertible.rb#132
  def hook_owner; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#181
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#88
  def output_ext; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#172
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#25
  def published?; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/convertible.rb#37
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/convertible.rb#192
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#107
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#162
  def render_with_liquid?; end

  # source://jekyll//lib/jekyll/convertible.rb#243
  def renderer; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#148
  def sass_file?; end
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#114
  def to_liquid(attrs = T.unsafe(nil)); end

  # Returns the contents as a String.
  #
  # source://jekyll//lib/jekyll/convertible.rb#20
  def to_s; end
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#80
  def transform; end
  ...
  #
  # source://jekyll//lib/jekyll/convertible.rb#127
  def type; end

  # source://jekyll//lib/jekyll/convertible.rb#64
  def validate_data!(filename); end

  # source://jekyll//lib/jekyll/convertible.rb#71
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/convertible.rb#222
  def write(dest); end

  private

  # source://jekyll//lib/jekyll/convertible.rb#249
  def defaults; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/convertible.rb#253
  def no_layout?; end
end

# source://jekyll//lib/jekyll/readers/data_reader.rb#4
class Jekyll::DataReader
  # @return [DataReader] a new instance of DataReader
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#7
  def initialize(site, in_source_dir: T.unsafe(nil)); end

  # Returns the value of attribute content.
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#5
  def content; end
  ...
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#21
  def read(dir); end
  ...
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#57
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#34
  def read_data_to(dir, data); end

  # source://jekyll//lib/jekyll/readers/data_reader.rb#70
  ...
  # source://jekyll//lib/jekyll/readers/data_reader.rb#103
  def config; end

  # @param row [Array, CSV::Row]
  # @return [Array, Hash]
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#109
  def convert_row(row); end

  # @return [Hash]
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#78
  def csv_config; end
  ...
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#91
  def read_config(config_key, overrides = T.unsafe(nil)); end

  # @return [Hash]
  #
  # source://jekyll//lib/jekyll/readers/data_reader.rb#83
  def tsv_config; end
end

# source://jekyll//lib/jekyll/deprecator.rb#4
module Jekyll::Deprecator
  extend ::Jekyll::Deprecator

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/deprecator.rb#36
  def arg_is_present?(args, deprecated_argument, message); end

  # source://jekyll//lib/jekyll/deprecator.rb#44
  def defaults_deprecate_type(old, current); end

  # source://jekyll//lib/jekyll/deprecator.rb#40
  def deprecation_message(message); end

  # source://jekyll//lib/jekyll/deprecator.rb#27
  def no_subcommand(args); end

  # source://jekyll//lib/jekyll/deprecator.rb#7
  def process(args); end
end

# source://jekyll//lib/jekyll/document.rb#4
class Jekyll::Document
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#42
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#342
  def <=>(other); end

  # source://jekyll//lib/jekyll/document.rb#250
  def [](key); end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#172
  def asset_file?; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#132
  def basename; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#125
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/document.rb#426
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#153
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#186
  def coffeescript_file?; end

  # Returns the value of attribute collection.
  #
  # source://jekyll//lib/jekyll/document.rb#8
  def collection; end

  # Returns the value of attribute content.
  #
  # source://jekyll//lib/jekyll/document.rb#9
  def content; end
  ...
  #   no data was read.
  #
  # source://jekyll//lib/jekyll/document.rb#68
  def data; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#86
  def date; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#259
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#102
  def draft?; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#369
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#376
  def generate_excerpt?; end

  # source://jekyll//lib/jekyll/document.rb#395
  def id; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#326
  def inspect; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#75
  def merge_data!(other, source: T.unsafe(nil)); end

  # Override of method_missing to check in @data for the key.
  #
  # source://jekyll//lib/jekyll/document.rb#407
  def method_missing(method, *args, &blck); end

  # source://jekyll//lib/jekyll/document.rb#380
  def next_doc; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#204
  def no_layout?; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#118
  def output_ext; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#235
  def permalink; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#212
  def place_in_layout?; end

  # source://jekyll//lib/jekyll/document.rb#438
  def populate_categories; end

  # source://jekyll//lib/jekyll/document.rb#449
  def populate_tags; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def post_read(*args, **_arg1, &block); end

  # source://jekyll//lib/jekyll/document.rb#385
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#290
  def published?; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/document.rb#299
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#402
  ...
  # to this document.
  #
  # source://jekyll//lib/jekyll/document.rb#111
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#195
  def render_with_liquid?; end

  # source://jekyll//lib/jekyll/document.rb#136
  def renderer; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#179
  def sass_file?; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#93
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#318
  def to_liquid; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#333
  def to_s; end

  # source://jekyll//lib/jekyll/document.rb#390
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#242
  def url; end
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#227
  ...
  #
  # source://jekyll//lib/jekyll/document.rb#219
  def url_template; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/document.rb#277
  def write(dest); end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#358
  def write?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#163
  def yaml_file?; end

  private

  # source://jekyll//lib/jekyll/document.rb#539
  def generate_excerpt; end

  # source://jekyll//lib/jekyll/document.rb#498
  def handle_read_error(error); end

  # source://jekyll//lib/jekyll/document.rb#458
  def merge_categories!(other); end

  # source://jekyll//lib/jekyll/document.rb#468
  def merge_date!(source); end

  # source://jekyll//lib/jekyll/document.rb#477
  def merge_defaults; end

  # source://jekyll//lib/jekyll/document.rb#533
  def modify_date(date); end

  # source://jekyll//lib/jekyll/document.rb#510
  def populate_title; end

  # source://jekyll//lib/jekyll/document.rb#482
  def read_content(**opts); end

  # source://jekyll//lib/jekyll/document.rb#491
  def read_post_data; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/document.rb#417
...
class Jekyll::Drops::CollectionDrop < ::Jekyll::Drops::Drop
  ...
  # source://jekyll//lib/jekyll/drops/drop.rb#72
  def output; end

  # source://jekyll//lib/jekyll/drops/drop.rb#65
  def relative_directory; end

  # source://jekyll//lib/jekyll/drops/collection_drop.rb#15
  def to_s; end
...
# source://jekyll//lib/jekyll/drops/document_drop.rb#5
class Jekyll::Drops::DocumentDrop < ::Jekyll::Drops::Drop
  extend ::Forwardable

  # source://jekyll//lib/jekyll/drops/document_drop.rb#32
  def <=>(other); end

  # source://jekyll//lib/jekyll/drops/drop.rb#91
  def categories; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/document_drop.rb#67
  def collapse_document(doc); end

  # source://jekyll//lib/jekyll/drops/document_drop.rb#20
  def collection; end
  ...
  # source://jekyll//lib/jekyll/drops/document_drop.rb#24
  def excerpt; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/document_drop.rb#54
  def hash_for_json(state = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/drops/drop.rb#65
  def id; end

  # source://jekyll//lib/jekyll/drops/document_drop.rb#28
  def name; end

  # source://jekyll//lib/jekyll/drops/document_drop.rb#44
  def next; end
  ...
  # source://jekyll//lib/jekyll/drops/document_drop.rb#40
  def previous; end
...
# source://jekyll//lib/jekyll/drops/document_drop.rb#8
Jekyll::Drops::DocumentDrop::NESTED_OBJECT_FIELD_BLACKLIST = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/drops/drop.rb#5
class Jekyll::Drops::Drop < ::Liquid::Drop
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#112
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#124
  def [](key); end
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#148
  def []=(key, val); end
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#167
  def content_methods; end

  # source://jekyll//lib/jekyll/drops/drop.rb#244
  def each; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#240
  ...
  # @raise [KeyError]
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#279
  ...
  # Returns a Hash ready for JSON generation.
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#222
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#214
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#179
  def key?(key); end
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#192
  def keys; end

  # source://jekyll//lib/jekyll/drops/drop.rb#250
  def merge(other, &block); end

  # source://jekyll//lib/jekyll/drops/drop.rb#260
  def merge!(other); end
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#203
  def to_h; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/drop.rb#231
  def to_json(state = T.unsafe(nil)); end

  private

  # source://jekyll//lib/jekyll/drops/drop.rb#288
  def mutations; end
  ...
  class << self
    ...
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#90
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#79
    ...
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#64
    ...
    # Returns delegated method symbol.
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#71
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#56
    ...
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#99
    ...
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#34
    def mutable(is_mutable = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#38
    def mutable?; end
    ...
    # Returns nothing.
    #
    # source://jekyll//lib/jekyll/drops/drop.rb#48
    def private_delegate_methods(*symbols); end
  end
end

# source://jekyll//lib/jekyll/drops/drop.rb#8
Jekyll::Drops::Drop::NON_CONTENT_METHODS = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/drops/drop.rb#9
...
#
# source://jekyll//lib/jekyll/drops/drop.rb#16
Jekyll::Drops::Drop::SETTER_KEYS_STASH = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/drops/excerpt_drop.rb#5
class Jekyll::Drops::ExcerptDrop < ::Jekyll::Drops::DocumentDrop
  # source://jekyll//lib/jekyll/drops/excerpt_drop.rb#10
  def date; end

  # source://jekyll//lib/jekyll/drops/excerpt_drop.rb#14
  def excerpt; end

  # source://jekyll//lib/jekyll/drops/excerpt_drop.rb#6
  def layout; end

  # source://jekyll//lib/jekyll/drops/excerpt_drop.rb#18
  def name; end
end

# source://jekyll//lib/jekyll/drops/jekyll_drop.rb#5
class Jekyll::Drops::JekyllDrop < ::Liquid::Drop
  # source://jekyll//lib/jekyll/drops/jekyll_drop.rb#16
  def environment; end

  # source://jekyll//lib/jekyll/drops/jekyll_drop.rb#20
  def to_h; end

  # source://jekyll//lib/jekyll/drops/jekyll_drop.rb#27
  def to_json(state = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/drops/jekyll_drop.rb#12
  def version; end

  class << self
    # source://jekyll//lib/jekyll/drops/jekyll_drop.rb#7
    def global; end
  end
end

# source://jekyll//lib/jekyll/drops/site_drop.rb#5
class Jekyll::Drops::SiteDrop < ::Jekyll::Drops::Drop
  extend ::Forwardable

  # source://jekyll//lib/jekyll/drops/site_drop.rb#15
  def [](key); end

  # source://jekyll//lib/jekyll/drops/drop.rb#65
  def categories; end

  # source://jekyll//lib/jekyll/drops/site_drop.rb#37
  def collections; end

  # return nil for `{{ site.config }}` even if --config was passed via CLI
  #
  # source://jekyll//lib/jekyll/drops/site_drop.rb#63
  def config; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/site_drop.rb#60
  ...
  #
  # source://jekyll//lib/jekyll/drops/site_drop.rb#47
  def documents; end

  # source://jekyll//lib/jekyll/drops/site_drop.rb#31
  def html_pages; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/drops/site_drop.rb#23
  def key?(key); end

  # source://jekyll//lib/jekyll/drops/drop.rb#65
  def pages; end

  # source://jekyll//lib/jekyll/drops/site_drop.rb#27
  def posts; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/site_drop.rb#55
  def related_posts; end
...
# source://jekyll//lib/jekyll/drops/static_file_drop.rb#5
...
# source://jekyll//lib/jekyll/drops/theme_drop.rb#5
class Jekyll::Drops::ThemeDrop < ::Jekyll::Drops::Drop
  # source://jekyll//lib/jekyll/drops/theme_drop.rb#9
  def authors; end

  # source://jekyll//lib/jekyll/drops/drop.rb#72
  def dependencies; end

  # source://jekyll//lib/jekyll/drops/theme_drop.rb#17
  def description; end

  # source://jekyll//lib/jekyll/drops/theme_drop.rb#21
  def metadata; end

  # source://jekyll//lib/jekyll/drops/drop.rb#65
  def root; end

  # source://jekyll//lib/jekyll/drops/theme_drop.rb#13
  def version; end

  private

  # source://jekyll//lib/jekyll/drops/theme_drop.rb#31
  def fallback_data; end

  # source://jekyll//lib/jekyll/drops/theme_drop.rb#27
  def gemspec; end
end

# source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#5
class Jekyll::Drops::UnifiedPayloadDrop < ::Jekyll::Drops::Drop
  # Returns the value of attribute content.
  #
  # source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#8
  def content; end
  ...
  # source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#11
  def jekyll; end
  ...
  # source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#15
  def site; end

  # source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#19
  def theme; end

  private

  # source://jekyll//lib/jekyll/drops/unified_payload_drop.rb#25
  def fallback_data; end
end

# source://jekyll//lib/jekyll/drops/url_drop.rb#5
class Jekyll::Drops::UrlDrop < ::Jekyll::Drops::Drop
  extend ::Forwardable

  # source://jekyll//lib/jekyll/drops/url_drop.rb#30
  def categories; end

  # source://jekyll//lib/jekyll/drops/url_drop.rb#13
  def collection; end

  # DD: 01..31
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#57
  def day; end

  # hh: 00..23
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#62
  def hour; end

  # D: 1..31
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#77
  def i_day; end

  # M: 1..12
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#82
  def i_month; end

  # ddd: Monday..Sunday
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#124
  def long_day; end

  # MMMM: January..December
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#92
  def long_month; end

  # mm: 00..59
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#67
  def minute; end

  # MM: 01..12
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#52
  def month; end

  # source://jekyll//lib/jekyll/drops/url_drop.rb#17
  def name; end
  ...
  # ss: 00..59
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#72
  def second; end

  # dd: Mon..Sun
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#119
  def short_day; end

  # MMM: Jan..Dec
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#87
  def short_month; end

  # YY: 00..99
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#97
  def short_year; end

  # source://jekyll//lib/jekyll/drops/url_drop.rb#26
  def slug; end
  ...
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#40
  def slugified_categories; end

  # source://jekyll//lib/jekyll/drops/url_drop.rb#21
  def title; end

  # d: 1..7 (Monday..Sunday)
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#114
  def w_day; end

  # CCYYw, ISO week year
  # may differ from CCYY for the first days of January and last days of December
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#103
  def w_year; end

  # WW: 01..53
  # %W and %U do not comply with ISO 8601-1
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#109
  def week; end

  # DDD: 001..366
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#129
  def y_day; end

  # CCYY
  #
  # source://jekyll//lib/jekyll/drops/url_drop.rb#47
  def year; end

  private

  # source://jekyll//lib/jekyll/drops/url_drop.rb#135
  def fallback_data; end
end

# source://jekyll//lib/jekyll/entry_filter.rb#4
class Jekyll::EntryFilter
  # @return [EntryFilter] a new instance of EntryFilter
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#9
  def initialize(site, base_directory = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#64
  def backup?(entry); end

  # source://jekyll//lib/jekyll/entry_filter.rb#16
  def base_directory; end

  # source://jekyll//lib/jekyll/entry_filter.rb#20
  def derive_base_directory(site, base_dir); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#68
  def excluded?(entry); end

  # source://jekyll//lib/jekyll/entry_filter.rb#31
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#97
  def glob_include?(enumerator, entry); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#54
  def included?(entry); end

  # source://jekyll//lib/jekyll/entry_filter.rb#25
  def relative_to_source(entry); end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#5
  def site; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#59
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/entry_filter.rb#84
...
class Jekyll::Excerpt
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#23
  ...
  # Returns the value of attribute content.
  #
  # source://jekyll//lib/jekyll/excerpt.rb#7
  def content; end
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#31
  def data; end
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#65
  def id; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/excerpt.rb#57
  def include?(something); end

  # Returns the shorthand String identifier of this doc.
  #
  # source://jekyll//lib/jekyll/excerpt.rb#78
  def inspect; end
  ...
  # source://jekyll//lib/jekyll/excerpt.rb#82
  def output; end
  ...
  # @param value the value to set the attribute output to.
  #
  # source://jekyll//lib/jekyll/excerpt.rb#8
  def output=(_arg0); end
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#43
  def path; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/excerpt.rb#86
  def place_in_layout?; end
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#50
  def relative_path; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/excerpt.rb#90
  def render_with_liquid?; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def site(*args, **_arg1, &block); end

  # source://jekyll//lib/jekyll/excerpt.rb#73
  def to_liquid; end

  # source://jekyll//lib/jekyll/excerpt.rb#69
  def to_s; end

  # source://jekyll//lib/jekyll/excerpt.rb#38
  ...
  # source://jekyll//lib/jekyll/excerpt.rb#136
  ...
  # source://jekyll//lib/jekyll/excerpt.rb#175
  def endtag_regex_stash(tag_name); end

  # source://jekyll//lib/jekyll/excerpt.rb#167
  def extract_markdown_link_reference_definitions(head, tail); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/excerpt.rb#180
  def liquid_block?(tag_name); end

  # source://jekyll//lib/jekyll/excerpt.rb#191
  ...
  #
  # source://jekyll//lib/jekyll/excerpt.rb#151
...
#
# source://jekyll//lib/jekyll/excerpt.rb#133
Jekyll::Excerpt::LIQUID_TAG_REGEX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/excerpt.rb#134
Jekyll::Excerpt::MKDWN_LINK_REF_REGEX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/external.rb#4
module Jekyll::External
  class << self
    # Gems that, if installed, should be loaded.
    # Usually contain subcommands.
    #
    # source://jekyll//lib/jekyll/external.rb#10
    ...
    #
    # source://jekyll//lib/jekyll/external.rb#23
    ...
    # names - a string gem name or array of gem names
    #
    # source://jekyll//lib/jekyll/external.rb#54
    ...
    # RubyGems.
    #
    # source://jekyll//lib/jekyll/external.rb#41
    def version_constraint(gem_name); end
  end
end

# source://jekyll//lib/jekyll/filters/date_filters.rb#4
module Jekyll::Filters
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#152
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#92
  ...
  #
  #
  # source://jekyll//lib/jekyll/filters.rb#235
  ...
  # Returns the found object or nil
  #
  # source://jekyll//lib/jekyll/filters.rb#268
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#371
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#170
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#16
  ...
  # Returns the formatted String
  #
  # source://jekyll//lib/jekyll/filters.rb#115
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#124
  def number_of_words(input, mode = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/filters.rb#321
  def pop(array, num = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/filters.rb#330
  def push(array, input); end

  # source://jekyll//lib/jekyll/filters.rb#355
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#38
  ...
  # Returns the CSS formatted String.
  #
  # source://jekyll//lib/jekyll/filters.rb#49
  def scssify(input); end

  # source://jekyll//lib/jekyll/filters.rb#338
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#62
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#27
  ...
  # @raise [ArgumentError]
  #
  # source://jekyll//lib/jekyll/filters.rb#301
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#287
  def to_integer(input); end

  # source://jekyll//lib/jekyll/filters.rb#347
  ...
  # Returns the escaped String.
  #
  # source://jekyll//lib/jekyll/filters.rb#106
  ...
  # Returns the filtered array of objects
  #
  # source://jekyll//lib/jekyll/filters.rb#183
  ...
  # Returns the filtered array of objects
  #
  # source://jekyll//lib/jekyll/filters.rb#209
  ...
  # Returns the escaped String.
  #
  # source://jekyll//lib/jekyll/filters.rb#77
  def xml_escape(input); end

  private

  # source://jekyll//lib/jekyll/filters.rb#459
  def as_liquid(item); end

  # `where` filter helper
  #
  # source://jekyll//lib/jekyll/filters.rb#400
  def compare_property_vs_target(property, target); end

  # source://jekyll//lib/jekyll/filters.rb#421
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#499
  ...
  # Returns an instance of Liquid::Condition
  #
  # source://jekyll//lib/jekyll/filters.rb#516
  def parse_comparison(parser); end

  # Parse a string to a Liquid Condition
  #
  # source://jekyll//lib/jekyll/filters.rb#484
  def parse_condition(exp); end

  # return numeric values as numbers for proper sorting
  #
  # source://jekyll//lib/jekyll/filters.rb#451
  def parse_sort_input(property); end

  # source://jekyll//lib/jekyll/filters.rb#438
  ...
  #
  # source://jekyll//lib/jekyll/filters.rb#381
  def sort_input(input, property, order); end
end

# source://jekyll//lib/jekyll/filters/date_filters.rb#5
module Jekyll::Filters::DateFilters
  ...
  # Returns the formatted String.
  #
  # source://jekyll//lib/jekyll/filters/date_filters.rb#32
  ...
  # Returns the formatted String.
  #
  # source://jekyll//lib/jekyll/filters/date_filters.rb#62
  ...
  #
  # source://jekyll//lib/jekyll/filters/date_filters.rb#17
  ...
  # Returns the formatted String.
  #
  # source://jekyll//lib/jekyll/filters/date_filters.rb#46
  def date_to_xmlschema(date); end

  private

  # source://jekyll//lib/jekyll/filters/date_filters.rb#89
  ...
  #
  # source://jekyll//lib/jekyll/filters/date_filters.rb#75
  def stringify_date(date, month_type, type = T.unsafe(nil), style = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/filters/date_filters.rb#100
  def time(input); end
end

# source://jekyll//lib/jekyll/filters.rb#446
Jekyll::Filters::FLOAT_LIKE = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/filters/grouping_filters.rb#5
module Jekyll::Filters::GroupingFilters
  ...
  #
  # source://jekyll//lib/jekyll/filters/grouping_filters.rb#14
  ...
  # Returns the filtered array of objects
  #
  # source://jekyll//lib/jekyll/filters/grouping_filters.rb#30
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/filters/grouping_filters.rb#49
  def groupable?(element); end

  # source://jekyll//lib/jekyll/filters/grouping_filters.rb#53
  def grouped_array(groups); end

  # source://jekyll//lib/jekyll/filters/grouping_filters.rb#45
  def parse_expression(str); end
end

# source://jekyll//lib/jekyll/filters.rb#447
Jekyll::Filters::INTEGER_LIKE = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/filters/url_filters.rb#5
module Jekyll::Filters::URLFilters
  ...
  #
  # source://jekyll//lib/jekyll/filters/url_filters.rb#11
  ...
  #
  # source://jekyll//lib/jekyll/filters/url_filters.rb#32
  ...
  #
  # source://jekyll//lib/jekyll/filters/url_filters.rb#52
  def strip_index(input); end

  private

  # source://jekyll//lib/jekyll/filters/url_filters.rb#60
  def compute_absolute_url(input); end

  # source://jekyll//lib/jekyll/filters/url_filters.rb#73
  def compute_relative_url(input); end

  # source://jekyll//lib/jekyll/filters/url_filters.rb#91
  def ensure_leading_slash(input); end

  # source://jekyll//lib/jekyll/filters/url_filters.rb#83
...
#
# source://jekyll//lib/jekyll/frontmatter_defaults.rb#9
class Jekyll::FrontmatterDefaults
  # Initializes a new instance.
  #
  # @return [FrontmatterDefaults] a new instance of FrontmatterDefaults
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#11
  def initialize(site); end
  ...
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#78
  def all(path, type); end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#40
  ...
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#59
  def find(path, type, setting); end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#15
  def reset; end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#19
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#101
  def applies?(scope, path, type); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#105
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#159
  def applies_type?(scope, type); end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#131
  def glob_cache(path); end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#118
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#179
  ...
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#198
  def matching_sets(path, type); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#136
  def path_is_subpath?(path, parent_path); end

  # Sanitizes the given path by removing a leading slash
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#228
  def sanitize_path(path); end

  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#140
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#168
  def valid?(set); end
  ...
  # Returns an array of hashes
  #
  # source://jekyll//lib/jekyll/frontmatter_defaults.rb#212
  def valid_sets; end
end

# source://jekyll//lib/jekyll/generator.rb#4
...
# source://jekyll//lib/jekyll/hooks.rb#4
module Jekyll::Hooks
  class << self
    # source://jekyll//lib/jekyll/hooks.rb#90
    def insert_hook(owner, event, priority, &block); end

    # Ensure the priority is a Fixnum
    #
    # source://jekyll//lib/jekyll/hooks.rb#64
    def priority_value(priority); end

    # register hook(s) to be called later, public API
    #
    # source://jekyll//lib/jekyll/hooks.rb#57
    ...
    # @raise [Uncallable]
    #
    # source://jekyll//lib/jekyll/hooks.rb#71
    def register_one(owner, event, priority, &block); end

    # interface for Jekyll core components to trigger hooks
    #
    # source://jekyll//lib/jekyll/hooks.rb#96
    def trigger(owner, event, *args); end
  end
end

# source://jekyll//lib/jekyll/hooks.rb#5
Jekyll::Hooks::DEFAULT_PRIORITY = T.let(T.unsafe(nil), Integer)

# source://jekyll//lib/jekyll/hooks.rb#53
class Jekyll::Hooks::NotAvailable < ::RuntimeError; end

# compatibility layer for octopress-hooks users
#
# source://jekyll//lib/jekyll/hooks.rb#8
Jekyll::Hooks::PRIORITY_MAP = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/hooks.rb#54
class Jekyll::Hooks::Uncallable < ::RuntimeError; end

# source://jekyll//lib/jekyll/inclusion.rb#4
class Jekyll::Inclusion
  # @return [Inclusion] a new instance of Inclusion
  #
  # source://jekyll//lib/jekyll/inclusion.rb#8
  def initialize(site, base, name); end

  # source://jekyll//lib/jekyll/inclusion.rb#23
  def content; end

  # source://jekyll//lib/jekyll/inclusion.rb#27
  def inspect; end

  # Returns the value of attribute name.
  #
  # source://jekyll//lib/jekyll/inclusion.rb#5
  def name; end
  ...
  # source://jekyll//lib/jekyll/inclusion.rb#14
...
# source://jekyll//lib/jekyll/layout.rb#4
class Jekyll::Layout
  ...
  #
  # source://jekyll//lib/jekyll/layout.rb#21
  def initialize(site, base, name); end

  # content of layout
  #
  # source://jekyll//lib/jekyll/layout.rb#7
  def content; end
  ...
  #
  # source://jekyll//lib/jekyll/layout.rb#51
  def inspect; end

  # name of layout
  #
  # source://jekyll//lib/jekyll/layout.rb#11
  def name; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/layout.rb#46
...
# source://jekyll//lib/jekyll/readers/layout_reader.rb#4
class Jekyll::LayoutReader
  # @return [LayoutReader] a new instance of LayoutReader
  #
  # source://jekyll//lib/jekyll/readers/layout_reader.rb#7
  def initialize(site); end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#26
  def layout_directory; end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#12
  def read; end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/readers/layout_reader.rb#5
  def site; end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#30
  def theme_layout_directory; end

  private

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#44
  def entries_in(dir); end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#36
  def layout_entries; end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#52
  def layout_name(file); end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#40
  def theme_layout_entries; end

  # source://jekyll//lib/jekyll/readers/layout_reader.rb#56
  def within(directory); end
end

# source://jekyll//lib/jekyll/liquid_extensions.rb#4
module Jekyll::LiquidExtensions
  ...
  #
  # source://jekyll//lib/jekyll/liquid_extensions.rb#12
  def lookup_variable(context, variable); end
end

# source://jekyll//lib/jekyll/liquid_renderer/file.rb#4
class Jekyll::LiquidRenderer
  # @return [LiquidRenderer] a new instance of LiquidRenderer
  #
  # source://jekyll//lib/jekyll/liquid_renderer.rb#8
  def initialize(site); end
  ...
  #
  # source://jekyll//lib/jekyll/liquid_renderer.rb#50
  def cache; end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#19
  def file(filename); end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#26
  def increment_bytes(filename, bytes); end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#34
  def increment_count(filename); end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#30
  def increment_time(filename, time); end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#14
  def reset; end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#38
  def stats_table(num_of_rows = T.unsafe(nil)); end

  private

  # source://jekyll//lib/jekyll/liquid_renderer.rb#76
  def new_profile_hash; end

  # source://jekyll//lib/jekyll/liquid_renderer.rb#56
  def normalize_path(filename); end

  class << self
    # source://jekyll//lib/jekyll/liquid_renderer.rb#42
    def format_error(error, path); end
  end
end

# source://jekyll//lib/jekyll/liquid_renderer/file.rb#5
class Jekyll::LiquidRenderer::File
  # @return [File] a new instance of File
  #
  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#6
  def initialize(renderer, filename); end

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#11
  def parse(content); end

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#20
  def render(*args); end

  # This method simply 'rethrows any error' before attempting to render the template.
  #
  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#33
  def render!(*args); end

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#45
  def warnings; end

  private

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#62
  def measure_bytes; end

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#57
  def measure_counts; end

  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#68
  ...
  #
  # source://jekyll//lib/jekyll/liquid_renderer/file.rb#53
  def reset_template_assigns; end
end

# source://jekyll//lib/jekyll/liquid_renderer/table.rb#5
class Jekyll::LiquidRenderer::Table
  # @return [Table] a new instance of Table
  #
  # source://jekyll//lib/jekyll/liquid_renderer/table.rb#8
  def initialize(stats); end

  # source://jekyll//lib/jekyll/liquid_renderer/table.rb#12
  def to_s(num_of_rows = T.unsafe(nil)); end

  private

  # source://jekyll//lib/jekyll/liquid_renderer/table.rb#18
  def data_for_table(num_of_rows); end

  # source://jekyll//lib/jekyll/liquid_renderer/table.rb#39
  def format_bytes(bytes); end

  # source://jekyll//lib/jekyll/liquid_renderer/table.rb#35
  def header_labels; end
end

# source://jekyll//lib/jekyll/liquid_renderer/table.rb#6
Jekyll::LiquidRenderer::Table::GAUGES = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/log_adapter.rb#4
class Jekyll::LogAdapter
  ...
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#20
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#95
  def abort_with(topic, message = T.unsafe(nil), &block); end

  # source://jekyll//lib/jekyll/log_adapter.rb#38
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#55
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#85
  ...
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#123
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#65
  def info(topic, message = T.unsafe(nil), &block); end

  # Returns the value of attribute level.
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#5
  def level; end
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#31
  ...
  # @raise [ArgumentError]
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#106
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#75
  ...
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#145
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/log_adapter.rb#132
...
# source://jekyll//lib/jekyll/log_adapter.rb#7
Jekyll::LogAdapter::LOG_LEVELS = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/page.rb#4
class Jekyll::Page
  include ::Jekyll::Convertible
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#37
  def initialize(site, base, dir, name); end

  # Returns the value of attribute basename.
  #
  # source://jekyll//lib/jekyll/page.rb#8
  def basename; end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#153
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#64
  def dir; end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#7
  def dir=(_arg0); end

  # source://jekyll//lib/jekyll/page.rb#190
  def excerpt; end

  # source://jekyll//lib/jekyll/page.rb#186
  def excerpt_separator; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/page.rb#196
  def generate_excerpt?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/page.rb#169
  def html?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/page.rb#174
  def index?; end

  # Returns the object as a debug String.
  #
  # source://jekyll//lib/jekyll/page.rb#164
  def inspect; end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#139
  def path; end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#72
  def permalink; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/page.rb#116
  def process(name); end

  # The path to the page source file, relative to the site source
  #
  # source://jekyll//lib/jekyll/page.rb#144
  def relative_path; end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#129
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#79
  def template; end

  # source://jekyll//lib/jekyll/page.rb#178
  def trigger_hooks(hook_name, *args); end
  ...
  #
  # source://jekyll//lib/jekyll/page.rb#92
  def url; end

  # Returns a hash of URL placeholder names (as symbols) mapping to the
  # desired placeholder replacements. For details see "url.rb"
  #
  # source://jekyll//lib/jekyll/page.rb#102
  def url_placeholders; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/page.rb#182
  def write?; end

  private

  # source://jekyll//lib/jekyll/page.rb#202
  def generate_excerpt; end

  # source://jekyll//lib/jekyll/page.rb#208
  def url_dir; end
end

# Attributes for Liquid templates
#
# source://jekyll//lib/jekyll/page.rb#13
Jekyll::Page::ATTRIBUTES_FOR_LIQUID = T.let(T.unsafe(nil), Array)

# A set of extensions that are considered HTML or HTML-like so we
# should not alter them,  this includes .xhtml through XHTM5.
#
# source://jekyll//lib/jekyll/page.rb#25
Jekyll::Page::HTML_EXTENSIONS = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/page_excerpt.rb#4
class Jekyll::PageExcerpt < ::Jekyll::Excerpt
  # Returns the value of attribute doc.
  #
  # source://jekyll//lib/jekyll/page_excerpt.rb#5
  def doc; end

  # source://jekyll//lib/jekyll/excerpt.rb#50
  def id; end

  # source://jekyll//lib/jekyll/page_excerpt.rb#21
  def inspect; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/page_excerpt.rb#15
  def render_with_liquid?; end

  # source://jekyll//lib/jekyll/page_excerpt.rb#11
  def to_liquid; end
end

# source://jekyll//lib/jekyll/page_excerpt.rb#8
Jekyll::PageExcerpt::EXCERPT_ATTRIBUTES = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/readers/page_reader.rb#4
class Jekyll::PageReader
  # @return [PageReader] a new instance of PageReader
  #
  # source://jekyll//lib/jekyll/readers/page_reader.rb#7
  def initialize(site, dir); end

  # Returns the value of attribute dir.
  #
  # source://jekyll//lib/jekyll/readers/page_reader.rb#5
  def dir; end
  ...
  #
  # source://jekyll//lib/jekyll/readers/page_reader.rb#18
  def read(files); end
...
#
# source://jekyll//lib/jekyll/page_without_a_file.rb#9
class Jekyll::PageWithoutAFile < ::Jekyll::Page
  # source://jekyll//lib/jekyll/page_without_a_file.rb#10
...
#
# source://jekyll//lib/jekyll/path_manager.rb#15
class Jekyll::PathManager
  class << self
    ...
    #
    # source://jekyll//lib/jekyll/path_manager.rb#24
    ...
    # Returns a frozen string.
    #
    # source://jekyll//lib/jekyll/path_manager.rb#36
    def sanitized_path(base_directory, questionable_path); end
    ...
    # source://jekyll//lib/jekyll/path_manager.rb#50
    def sanitize_and_join(base_directory, questionable_path); end

    # source://jekyll//lib/jekyll/path_manager.rb#68
    def slashed_dir_cache(base_directory); end
  end
end

# source://jekyll//lib/jekyll/plugin.rb#4
class Jekyll::Plugin
  ...
  #
  # source://jekyll//lib/jekyll/plugin.rb#88
  def initialize(config = T.unsafe(nil)); end
  ...
  # Returns -1, 0, 1.
  #
  # source://jekyll//lib/jekyll/plugin.rb#79
  def <=>(other); end
  ...
  class << self
    ...
    # Returns -1, 0, 1.
    #
    # source://jekyll//lib/jekyll/plugin.rb#70
    def <=>(other); end

    # source://jekyll//lib/jekyll/plugin.rb#23
    def catch_inheritance(const); end

    # source://jekyll//lib/jekyll/plugin.rb#32
    def descendants; end

    # @private
    #
    # source://jekyll//lib/jekyll/plugin.rb#15
    ...
    #
    # source://jekyll//lib/jekyll/plugin.rb#47
    ...
    #
    # source://jekyll//lib/jekyll/plugin.rb#60
    def safe(safe = T.unsafe(nil)); end
  end
end

# source://jekyll//lib/jekyll/plugin.rb#5
Jekyll::Plugin::PRIORITIES = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/plugin_manager.rb#4
class Jekyll::PluginManager
  ...
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#12
  def initialize(site); end
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#19
  def conscientious_require; end

  # source://jekyll//lib/jekyll/plugin_manager.rb#112
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#77
  ...
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#104
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#29
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#92
  ...
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#38
  def require_theme_deps; end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#5
  def site; end
  ...
  #
  # source://jekyll//lib/jekyll/plugin_manager.rb#85
  def whitelist; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://jekyll//lib/jekyll/plugin_manager.rb#67
    def gemfile_exists?; end

    # source://jekyll//lib/jekyll/plugin_manager.rb#48
    def require_from_bundler; end
  end
end

# source://jekyll//lib/jekyll/readers/post_reader.rb#4
class Jekyll::PostReader
  # @return [PostReader] a new instance of PostReader
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#7
  def initialize(site); end
  ...
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#52
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#17
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#27
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#37
  def read_publishable(dir, magic_dir, matcher); end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#5
  def site; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#65
  def processable?(doc); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/readers/post_reader.rb#77
  def publishable?(doc); end
end

# source://jekyll//lib/jekyll/profiler.rb#4
class Jekyll::Profiler
  # @return [Profiler] a new instance of Profiler
  #
  # source://jekyll//lib/jekyll/profiler.rb#30
  def initialize(site); end

  # source://jekyll//lib/jekyll/profiler.rb#34
  def profile_process; end

  class << self
    # source://jekyll//lib/jekyll/profiler.rb#12
    def tabulate(table_rows); end
  end
end

# source://jekyll//lib/jekyll/profiler.rb#5
Jekyll::Profiler::TERMINAL_TABLE_STYLES = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/publisher.rb#4
class Jekyll::Publisher
  # @return [Publisher] a new instance of Publisher
  #
  # source://jekyll//lib/jekyll/publisher.rb#5
  def initialize(site); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/publisher.rb#13
  def hidden_in_the_future?(thing); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/publisher.rb#9
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/publisher.rb#19
  def can_be_published?(thing); end
end

# source://jekyll//lib/jekyll/reader.rb#4
class Jekyll::Reader
  # @return [Reader] a new instance of Reader
  #
  # source://jekyll//lib/jekyll/reader.rb#7
  def initialize(site); end
  ...
  #
  # source://jekyll//lib/jekyll/reader.rb#141
  ...
  #
  # source://jekyll//lib/jekyll/reader.rb#151
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#14
  def read; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#30
  def read_data; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#55
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#102
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#117
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#88
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/reader.rb#128
  def retrieve_static_files(dir, dot_static_files); end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/reader.rb#5
  def site; end

  # Sorts posts, pages, and static files.
  #
  # source://jekyll//lib/jekyll/reader.rb#42
  def sort_files!; end

  private

  # source://jekyll//lib/jekyll/reader.rb#200
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/reader.rb#169
  ...
  #
  # source://jekyll//lib/jekyll/reader.rb#176
  def post_reader; end

  # source://jekyll//lib/jekyll/reader.rb#180
  def read_included_excludes; end

  # source://jekyll//lib/jekyll/reader.rb#192
  def read_included_file(entry_path); end
end

# source://jekyll//lib/jekyll/regenerator.rb#4
class Jekyll::Regenerator
  # @return [Regenerator] a new instance of Regenerator
  #
  # source://jekyll//lib/jekyll/regenerator.rb#9
  def initialize(site); end
  ...
  #
  # source://jekyll//lib/jekyll/regenerator.rb#40
  def add(path); end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/regenerator.rb#106
  def add_dependency(path, dependency); end

  # Returns the value of attribute cache.
  #
  # source://jekyll//lib/jekyll/regenerator.rb#5
  def cache; end
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/regenerator.rb#60
  def clear; end
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/regenerator.rb#68
  def clear_cache; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#136
  def disabled?; end
  ...
  # Returns true.
  #
  # source://jekyll//lib/jekyll/regenerator.rb#53
  def force(path); end
  ...
  #
  # source://jekyll//lib/jekyll/regenerator.rb#129
  def metadata_file; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#84
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#22
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#76
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/regenerator.rb#119
  ...
  #
  # source://jekyll//lib/jekyll/regenerator.rb#6
  def disabled; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#179
  ...
  #
  # source://jekyll//lib/jekyll/regenerator.rb#147
  def read_metadata; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#172
  def regenerate_document?(document); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/regenerator.rb#165
  def regenerate_page?(document); end
end

# source://jekyll//lib/jekyll/related_posts.rb#4
class Jekyll::RelatedPosts
  # @return [RelatedPosts] a new instance of RelatedPosts
  #
  # source://jekyll//lib/jekyll/related_posts.rb#11
  def initialize(post); end

  # source://jekyll//lib/jekyll/related_posts.rb#17
  def build; end

  # source://jekyll//lib/jekyll/related_posts.rb#28
  def build_index; end

  # source://jekyll//lib/jekyll/related_posts.rb#44
  def lsi_related_posts; end

  # source://jekyll//lib/jekyll/related_posts.rb#48
  def most_recent_posts; end

  # Returns the value of attribute post.
  #
  # source://jekyll//lib/jekyll/related_posts.rb#9
  def post; end
  ...
  class << self
    ...
    #
    # source://jekyll//lib/jekyll/related_posts.rb#6
    def lsi; end
...
# source://jekyll//lib/jekyll/renderer.rb#4
class Jekyll::Renderer
  # @return [Renderer] a new instance of Renderer
  #
  # source://jekyll//lib/jekyll/renderer.rb#8
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#103
  def convert(content); end
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#38
  def converters; end

  # Returns the value of attribute document.
  #
  # source://jekyll//lib/jekyll/renderer.rb#5
  def document; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/renderer.rb#143
  def invalid_layout?(layout); end
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#30
  def layouts; end
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#6
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#45
  def output_ext; end
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#20
  def payload; end
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#150
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#70
  ...
  #
  # source://jekyll//lib/jekyll/renderer.rb#123
  ...
  # Returns String rendered document output
  #
  # source://jekyll//lib/jekyll/renderer.rb#52
  def run; end
  ...
  # source://jekyll//lib/jekyll/renderer.rb#200
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/renderer.rb#220
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/renderer.rb#227
  def assign_highlighter_options!; end

  # source://jekyll//lib/jekyll/renderer.rb#232
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/renderer.rb#212
  def assign_pages!; end

  # source://jekyll//lib/jekyll/renderer.rb#245
  def converter_output_ext; end

  # source://jekyll//lib/jekyll/renderer.rb#259
  def liquid_options; end

  # source://jekyll//lib/jekyll/renderer.rb#253
  def output_exts; end

  # source://jekyll//lib/jekyll/renderer.rb#237
  ...
  # Returns String rendered content
  #
  # source://jekyll//lib/jekyll/renderer.rb#188
  ...
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/renderer.rb#178
  def validate_layout(layout); end
end

# source://jekyll//lib/jekyll/site.rb#4
class Jekyll::Site
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#18
  def initialize(config); end

  # Returns the value of attribute baseurl.
  #
  # source://jekyll//lib/jekyll/site.rb#5
  def baseurl; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#12
  def cache_dir; end

  # source://jekyll//lib/jekyll/site.rb#272
  def categories; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#220
  def cleanup; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#164
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#154
  def collections; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#445
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#47
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#342
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#356
  def documents; end
  ...
  # source://jekyll//lib/jekyll/site.rb#362
  def each_site_file; end

  # Check that the destination dir isn't the source dir or a directory
  # parent to the source dir.
  #
  # source://jekyll//lib/jekyll/site.rb#139
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#305
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#372
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#190
  def generate; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#435
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#423
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#397
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#409
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/site.rb#379
  ...
  # Returns the object as a debug String.
  #
  # source://jekyll//lib/jekyll/site.rb#453
  def inspect; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#318
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#255
  def post_attr_hash(post_attr); end

  # source://jekyll//lib/jekyll/site.rb#238
  def posts; end

  # source://jekyll//lib/jekyll/site.rb#85
  def print_stats; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#74
  def process; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#387
  def publisher; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#180
  def read; end
  ...
  # Returns
  #
  # source://jekyll//lib/jekyll/site.rb#329
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#203
  def render; end
  ...
  # @raise [ArgumentError]
  #
  # source://jekyll//lib/jekyll/site.rb#95
  def reset; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#128
  def setup; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#280
  def site_data; end
  ...
  #                  See Site#post_attr_hash for type info.
  #
  # source://jekyll//lib/jekyll/site.rb#297
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#349
  def static_files_to_write; end

  # source://jekyll//lib/jekyll/site.rb#268
  def tags; end
  ...
  # Returns nothing.
  #
  # source://jekyll//lib/jekyll/site.rb#228
  def write; end
  ...
  #
  # source://jekyll//lib/jekyll/site.rb#515
  def configure_cache; end

  # source://jekyll//lib/jekyll/site.rb#548
  def configure_file_read_opts; end

  # source://jekyll//lib/jekyll/site.rb#543
  def configure_include_paths; end

  # source://jekyll//lib/jekyll/site.rb#524
  def configure_plugins; end

  # source://jekyll//lib/jekyll/site.rb#529
  def configure_theme; end

  # source://jekyll//lib/jekyll/site.rb#502
  def hide_cache_dir_from_git; end

  # Limits the current posts; removes the posts which exceed the limit_posts
  #
  # Returns nothing
  #
  # source://jekyll//lib/jekyll/site.rb#487
  def limit_posts!; end

  # source://jekyll//lib/jekyll/site.rb#459
  def load_theme_configuration(config); end

  # source://jekyll//lib/jekyll/site.rb#554
  def render_docs(payload); end

  # source://jekyll//lib/jekyll/site.rb#562
  def render_pages(payload); end

  # source://jekyll//lib/jekyll/site.rb#568
  ...
  # Returns The Cleaner
  #
  # source://jekyll//lib/jekyll/site.rb#498
  def site_cleaner; end
end

# source://jekyll//lib/jekyll/static_file.rb#4
class Jekyll::StaticFile
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#29
  ...
  # NOTE: `String#gsub` removes all trailing periods (in comparison to `String#chomp`)
  #
  # source://jekyll//lib/jekyll/static_file.rb#122
  def basename; end
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#148
  def cleaned_relative_path; end

  # source://jekyll//lib/jekyll/static_file.rb#112
  def data; end

  # Returns the front matter defaults defined for the file's URL and/or type
  # as defined in _config.yml.
  #
  # source://jekyll//lib/jekyll/static_file.rb#181
  def defaults; end
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#54
  def destination(dest); end

  # source://jekyll//lib/jekyll/static_file.rb#59
  def destination_rel_dir; end

  # Returns the value of attribute extname.
  #
  # source://jekyll//lib/jekyll/static_file.rb#7
  def extname; end

  # Returns a debug string on inspecting the static file.
  # Includes only the relative path of the object.
  #
  # source://jekyll//lib/jekyll/static_file.rb#187
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/static_file.rb#79
  def modified?; end

  # source://jekyll//lib/jekyll/static_file.rb#67
  def modified_time; end

  # Returns last modification time for this file.
  #
  # source://jekyll//lib/jekyll/static_file.rb#72
  def mtime; end
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#41
  def path; end

  # source://jekyll//lib/jekyll/static_file.rb#126
  ...
  # source://jekyll//lib/jekyll/static_file.rb#116
  def to_liquid; end

  # Returns the type of the collection if present, nil otherwise.
  #
  # source://jekyll//lib/jekyll/static_file.rb#175
  def type; end
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#160
  def url; end
  ...
  #
  # source://jekyll//lib/jekyll/static_file.rb#99
  def write(dest); end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/static_file.rb#87
  def write?; end

  private

  # source://jekyll//lib/jekyll/static_file.rb#193
  def copy_file(dest_path); end

  class << self
    # The cache of last modification times [path] -> mtime.
    #
    # source://jekyll//lib/jekyll/static_file.rb#13
    def mtimes; end

    # source://jekyll//lib/jekyll/static_file.rb#17
    def reset_cache; end
  end
end

# source://jekyll//lib/jekyll/readers/static_file_reader.rb#4
class Jekyll::StaticFileReader
  # @return [StaticFileReader] a new instance of StaticFileReader
  #
  # source://jekyll//lib/jekyll/readers/static_file_reader.rb#7
  def initialize(site, dir); end

  # Returns the value of attribute dir.
  #
  # source://jekyll//lib/jekyll/readers/static_file_reader.rb#5
  def dir; end
  ...
  #
  # source://jekyll//lib/jekyll/readers/static_file_reader.rb#18
  def read(files); end
...
# source://jekyll//lib/jekyll/stevenson.rb#4
class Jekyll::Stevenson < ::Logger
  # @return [Stevenson] a new instance of Stevenson
  #
  # source://jekyll//lib/jekyll/stevenson.rb#5
  def initialize; end

  # source://jekyll//lib/jekyll/stevenson.rb#15
  def add(severity, message = T.unsafe(nil), progname = T.unsafe(nil)); end

  # source://jekyll//lib/jekyll/stevenson.rb#46
  def close; end

  # Log an +ERROR+ message
  #
  # source://jekyll//lib/jekyll/stevenson.rb#42
  def error(progname = T.unsafe(nil), &block); end

  # Log a +WARN+ message
  #
  # source://jekyll//lib/jekyll/stevenson.rb#37
  def warn(progname = T.unsafe(nil), &block); end

  private

  # source://jekyll//lib/jekyll/stevenson.rb#52
  def logdevice(severity); end
end

# source://jekyll//lib/jekyll/tags/highlight.rb#4
module Jekyll::Tags; end

# source://jekyll//lib/jekyll/tags/highlight.rb#5
class Jekyll::Tags::HighlightBlock < ::Liquid::Block
  include ::Liquid::StandardFilters

  # @return [HighlightBlock] a new instance of HighlightBlock
  #
  # source://jekyll//lib/jekyll/tags/highlight.rb#15
  def initialize(tag_name, markup, tokens); end

  # source://jekyll//lib/jekyll/tags/highlight.rb#33
  def render(context); end

  private

  # source://jekyll//lib/jekyll/tags/highlight.rb#102
  def add_code_tag(code); end

  # source://jekyll//lib/jekyll/tags/highlight.rb#56
  def parse_options(input); end

  # source://jekyll//lib/jekyll/tags/highlight.rb#98
  def render_codehighlighter(code); end

  # source://jekyll//lib/jekyll/tags/highlight.rb#75
  def render_pygments(code, _context); end

  # source://jekyll//lib/jekyll/tags/highlight.rb#81
  def render_rouge(code); end
end

# source://jekyll//lib/jekyll/tags/highlight.rb#31
Jekyll::Tags::HighlightBlock::LEADING_OR_TRAILING_LINE_TERMINATORS = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/highlight.rb#54
...
#
# source://jekyll//lib/jekyll/tags/highlight.rb#13
Jekyll::Tags::HighlightBlock::SYNTAX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/include.rb#251
class Jekyll::Tags::IncludeRelativeTag < ::Jekyll::Tags::IncludeTag
  # source://jekyll//lib/jekyll/tags/include.rb#256
  def page_path(context); end

  # source://jekyll//lib/jekyll/tags/include.rb#252
  def tag_includes_dirs(context); end

  private

  # source://jekyll//lib/jekyll/tags/include.rb#265
  def resource_path(page, site); end
end

# source://jekyll//lib/jekyll/tags/include.rb#5
class Jekyll::Tags::IncludeTag < ::Liquid::Tag
  # @return [IncludeTag] a new instance of IncludeTag
  #
  # source://jekyll//lib/jekyll/tags/include.rb#19
  def initialize(tag_name, markup, tokens); end

  # source://jekyll//lib/jekyll/tags/include.rb#131
  def add_include_to_dependency(site, path, context); end

  # Grab file read opts in the context
  #
  # source://jekyll//lib/jekyll/tags/include.rb#84
  def file_read_opts(context); end

  # source://jekyll//lib/jekyll/tags/include.rb#140
  def load_cached_partial(path, context); end

  # @raise [IOError]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#97
  def locate_include_file(context, file, safe); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#164
  def outside_site_source?(path, dir, safe); end

  # source://jekyll//lib/jekyll/tags/include.rb#37
  def parse_params(context); end

  # This method allows to modify the file content by inheriting from the class.
  #
  # source://jekyll//lib/jekyll/tags/include.rb#175
  def read_file(file, context); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#168
  def realpath_prefixed_with?(path, dir); end

  # source://jekyll//lib/jekyll/tags/include.rb#106
  def render(context); end

  # Render the variable if required
  #
  # source://jekyll//lib/jekyll/tags/include.rb#89
  def render_variable(context); end

  # source://jekyll//lib/jekyll/tags/include.rb#33
  def syntax_example; end

  # source://jekyll//lib/jekyll/tags/include.rb#93
  def tag_includes_dirs(context); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#160
  def valid_include_file?(path, dir, safe); end

  # source://jekyll//lib/jekyll/tags/include.rb#53
  def validate_file_name(file); end

  # source://jekyll//lib/jekyll/tags/include.rb#68
  def validate_params; end

  private

  # source://jekyll//lib/jekyll/tags/include.rb#181
  def could_not_locate_message(file, includes_dirs, safe); end
end

# source://jekyll//lib/jekyll/tags/include.rb#15
Jekyll::Tags::IncludeTag::FULL_VALID_SYNTAX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/include.rb#17
Jekyll::Tags::IncludeTag::INVALID_SEQUENCES = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/include.rb#16
Jekyll::Tags::IncludeTag::VALID_FILENAME_CHARS = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/include.rb#6
Jekyll::Tags::IncludeTag::VALID_SYNTAX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/include.rb#10
Jekyll::Tags::IncludeTag::VARIABLE_SYNTAX = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/link.rb#5
class Jekyll::Tags::Link < ::Liquid::Tag
  include ::Jekyll::Filters::URLFilters

  # @return [Link] a new instance of Link
  #
  # source://jekyll//lib/jekyll/tags/link.rb#14
  def initialize(tag_name, relative_path, tokens); end

  # @raise [ArgumentError]
  #
  # source://jekyll//lib/jekyll/tags/link.rb#20
  def render(context); end

  class << self
    # source://jekyll//lib/jekyll/tags/link.rb#9
    def tag_name; end
  end
end
...
#
# source://jekyll//lib/jekyll/tags/include.rb#194
class Jekyll::Tags::OptimizedIncludeTag < ::Jekyll::Tags::IncludeTag
  # source://jekyll//lib/jekyll/tags/include.rb#195
  def render(context); end

  private

  # source://jekyll//lib/jekyll/tags/include.rb#236
  def add_include_to_dependency(inclusion, context); end

  # @raise [IOError]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#214
  def locate_include_file(file); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#226
  def outside_scope?(path, dir); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#230
  def realpath_prefixed_with?(path, dir); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/tags/include.rb#222
  def valid_include_file?(path, dir); end
end

# source://jekyll//lib/jekyll/tags/post_url.rb#5
class Jekyll::Tags::PostComparer
  # @return [PostComparer] a new instance of PostComparer
  #
  # source://jekyll//lib/jekyll/tags/post_url.rb#10
  def initialize(name); end

  # source://jekyll//lib/jekyll/tags/post_url.rb#30
  def ==(other); end

  # Returns the value of attribute date.
  #
  # source://jekyll//lib/jekyll/tags/post_url.rb#8
  def date; end

  # source://jekyll//lib/jekyll/tags/post_url.rb#34
  ...
  # source://jekyll//lib/jekyll/tags/post_url.rb#23
  def post_date; end
  ...
  #
  # source://jekyll//lib/jekyll/tags/post_url.rb#48
  def post_slug(other); end
end

# source://jekyll//lib/jekyll/tags/post_url.rb#6
Jekyll::Tags::PostComparer::MATCHER = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/tags/post_url.rb#58
class Jekyll::Tags::PostUrl < ::Liquid::Tag
  include ::Jekyll::Filters::URLFilters

  # @return [PostUrl] a new instance of PostUrl
  #
  # source://jekyll//lib/jekyll/tags/post_url.rb#61
  def initialize(tag_name, post, tokens); end

  # @raise [Jekyll::Errors::PostURLError]
  #
  # source://jekyll//lib/jekyll/tags/post_url.rb#75
  def render(context); end
end

# source://jekyll//lib/jekyll/theme.rb#4
class Jekyll::Theme
  extend ::Forwardable

  # @return [Theme] a new instance of Theme
  #
  # source://jekyll//lib/jekyll/theme.rb#10
  def initialize(name); end

  # source://jekyll//lib/jekyll/theme.rb#42
  def assets_path; end

  # The name of theme directory
  #
  # source://jekyll//lib/jekyll/theme.rb#26
  def basename; end

  # source://jekyll//lib/jekyll/theme.rb#46
  def data_path; end

  # source://jekyll//lib/jekyll/theme.rb#30
  def includes_path; end

  # source://jekyll//lib/jekyll/theme.rb#34
  def layouts_path; end

  # Returns the value of attribute name.
  #
  # source://jekyll//lib/jekyll/theme.rb#6
  def name; end

  # source://jekyll//lib/jekyll/theme.rb#16
  def root; end

  # source://jekyll//lib/jekyll/theme.rb#50
  def runtime_dependencies; end

  # source://jekyll//lib/jekyll/theme.rb#38
  def sass_path; end
  ...
  # source://jekyll//lib/jekyll/theme.rb#83
  def gemspec; end

  # source://jekyll//lib/jekyll/theme.rb#72
  def log_realpath_exception(err, folder); end

  # source://jekyll//lib/jekyll/theme.rb#56
  def path_for(folder); end

  # source://jekyll//lib/jekyll/theme.rb#61
  def realpath_for(folder); end
end

# source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#4
class Jekyll::ThemeAssetsReader
  # @return [ThemeAssetsReader] a new instance of ThemeAssetsReader
  #
  # source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#7
  def initialize(site); end

  # source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#11
  def read; end

  # Returns the value of attribute site.
  #
  # source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#5
  def site; end

  private

  # source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#41
  def append_unless_exists(haystack, new_item); end

  # source://jekyll//lib/jekyll/readers/theme_assets_reader.rb#27
  def read_theme_asset(path); end
end

# source://jekyll//lib/jekyll/theme_builder.rb#4
class Jekyll::ThemeBuilder
  # @return [ThemeBuilder] a new instance of ThemeBuilder
  #
  # source://jekyll//lib/jekyll/theme_builder.rb#11
  def initialize(theme_name, opts); end

  # Returns the value of attribute code_of_conduct.
  #
  # source://jekyll//lib/jekyll/theme_builder.rb#9
  def code_of_conduct; end

  # source://jekyll//lib/jekyll/theme_builder.rb#17
  def create!; end
  ...
  # source://jekyll//lib/jekyll/theme_builder.rb#29
  def user_email; end

  # source://jekyll//lib/jekyll/theme_builder.rb#25
  def user_name; end

  private

  # source://jekyll//lib/jekyll/theme_builder.rb#83
  def create_accessories; end

  # source://jekyll//lib/jekyll/theme_builder.rb#68
  def create_directories; end

  # source://jekyll//lib/jekyll/theme_builder.rb#78
  def create_gemspec; end

  # source://jekyll//lib/jekyll/theme_builder.rb#72
  def create_starter_files; end

  # source://jekyll//lib/jekyll/theme_builder.rb#50
  def erb; end

  # source://jekyll//lib/jekyll/theme_builder.rb#91
  def initialize_git_repo; end

  # source://jekyll//lib/jekyll/theme_builder.rb#54
  def mkdir_p(directories); end

  # source://jekyll//lib/jekyll/theme_builder.rb#35
  def root; end

  # source://jekyll//lib/jekyll/theme_builder.rb#46
  def template(filename); end

  # source://jekyll//lib/jekyll/theme_builder.rb#39
  def template_file(filename); end

  # source://jekyll//lib/jekyll/theme_builder.rb#62
  def write_file(filename, contents); end
end

# source://jekyll//lib/jekyll/theme_builder.rb#97
class Jekyll::ThemeBuilder::ERBRenderer
  extend ::Forwardable

  # @return [ERBRenderer] a new instance of ERBRenderer
  #
  # source://jekyll//lib/jekyll/theme_builder.rb#104
  def initialize(theme_builder); end

  # source://jekyll//lib/jekyll/theme_builder.rb#108
  def jekyll_version_with_minor; end

  # source://jekyll//lib/jekyll/theme_builder.rb#116
  def render(contents); end

  # source://jekyll//lib/jekyll/theme_builder.rb#112
...
# source://jekyll//lib/jekyll/theme_builder.rb#5
Jekyll::ThemeBuilder::SCAFFOLD_DIRECTORIES = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/url.rb#13
class Jekyll::URL
  ...
  #
  # source://jekyll//lib/jekyll/url.rb#25
  ...
  #
  # source://jekyll//lib/jekyll/url.rb#60
  def generate_url(template); end

  # source://jekyll//lib/jekyll/url.rb#95
  def generate_url_from_drop(template); end

  # source://jekyll//lib/jekyll/url.rb#68
  ...
  #
  # source://jekyll//lib/jekyll/url.rb#45
  ...
  # Returns the unsanitized String URL
  #
  # source://jekyll//lib/jekyll/url.rb#52
  ...
  # possibility.
  #
  # source://jekyll//lib/jekyll/url.rb#87
  def possible_keys(key); end

  # Returns a sanitized String URL, stripping "../../" and multiples of "/",
  # as well as the beginning "/" so we can enforce and ensure it.
  #
  # source://jekyll//lib/jekyll/url.rb#117
  ...
  # Returns the String URL
  #
  # source://jekyll//lib/jekyll/url.rb#38
  def to_s; end
  ...
  class << self
    ...
    #
    # source://jekyll//lib/jekyll/url.rb#134
    ...
    #
    # source://jekyll//lib/jekyll/url.rb#160
    def unescape_path(path); end
  end
end

# source://jekyll//lib/jekyll/utils.rb#4
module Jekyll::Utils
  extend ::Jekyll::Utils
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#253
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#28
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#41
  def deep_merge_hashes!(target, overwrite); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils.rb#53
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils.rb#150
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils.rb#141
  def has_yaml_header?(file); end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils.rb#49
  def mergable?(value); end

  # Returns merged option hash for File.read of self.site (if exists)
  # and a given param
  #
  # source://jekyll//lib/jekyll/utils.rb#305
  ...
  # if not
  #
  # source://jekyll//lib/jekyll/utils.rb#130
  ...
  # Returns an array
  #
  # source://jekyll//lib/jekyll/utils.rb#70
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#292
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#202
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#119
  ...
  #
  # source://jekyll//lib/jekyll/utils.rb#110
  def symbolize_hash_keys(hash); end

  # Takes a slug and turns it into a simple title.
  #
  # source://jekyll//lib/jekyll/utils.rb#21
  def titleize_slug(slug); end

  # source://jekyll//lib/jekyll/utils.rb#97
  def transform_keys(hash); end

  # source://jekyll//lib/jekyll/utils.rb#85
  def value_from_plural_key(hash, key); end

  # source://jekyll//lib/jekyll/utils.rb#81
  def value_from_singular_key(hash, key); end

  private

  # source://jekyll//lib/jekyll/utils.rb#339
  def duplicate_frozen_values(target); end

  # source://jekyll//lib/jekyll/utils.rb#333
  def merge_default_proc(target, overwrite); end

  # source://jekyll//lib/jekyll/utils.rb#321
...
module Jekyll::Utils::Ansi
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/ansi.rb#31
  def has?(str); end
  ...
  #
  # source://jekyll//lib/jekyll/utils/ansi.rb#39
  ...
  #
  # source://jekyll//lib/jekyll/utils/ansi.rb#25
  def strip(str); end
...
# source://jekyll//lib/jekyll/utils/ansi.rb#10
Jekyll::Utils::Ansi::COLORS = T.let(T.unsafe(nil), Hash)

# source://jekyll//lib/jekyll/utils/ansi.rb#8
Jekyll::Utils::Ansi::ESCAPE = T.let(T.unsafe(nil), String)

# source://jekyll//lib/jekyll/utils/ansi.rb#9
Jekyll::Utils::Ansi::MATCH = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/utils/exec.rb#7
module Jekyll::Utils::Exec
  ...
  # that order.
  #
  # source://jekyll//lib/jekyll/utils/exec.rb#16
  def run(*args); end
end

# source://jekyll//lib/jekyll/utils/internet.rb#5
module Jekyll::Utils::Internet
  private

  # source://jekyll//lib/jekyll/utils/internet.rb#23
  def connected?; end

  # source://jekyll//lib/jekyll/utils/internet.rb#27
  def dns(domain); end
...
# source://jekyll//lib/jekyll/utils/platforms.rb#5
module Jekyll::Utils::Platforms
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#27
  def bash_on_windows?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#8
  def jruby?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#31
  def linux?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#12
  def mri?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#35
  def osx?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#21
  def really_windows?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#39
  def unix?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#16
  def windows?; end
  ...
  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#58
  def linux_os?; end

  # @return [Boolean]
  #
  # source://jekyll//lib/jekyll/utils/platforms.rb#62
  def microsoft_proc_version?; end

  # source://jekyll//lib/jekyll/utils/platforms.rb#45
  def proc_version; end

  # source://jekyll//lib/jekyll/utils/platforms.rb#54
  def rbconfig_host; end
end

# source://jekyll//lib/jekyll/utils.rb#18
Jekyll::Utils::SLUGIFY_ASCII_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/utils.rb#16
Jekyll::Utils::SLUGIFY_DEFAULT_REGEXP = T.let(T.unsafe(nil), Regexp)

# Constants for use in #slugify
#
# source://jekyll//lib/jekyll/utils.rb#14
Jekyll::Utils::SLUGIFY_MODES = T.let(T.unsafe(nil), Array)

# source://jekyll//lib/jekyll/utils.rb#17
Jekyll::Utils::SLUGIFY_PRETTY_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://jekyll//lib/jekyll/utils.rb#15
...
#
# source://jekyll//lib/jekyll/utils/thread_event.rb#7
class Jekyll::Utils::ThreadEvent
  # @return [ThreadEvent] a new instance of ThreadEvent
  #
  # source://jekyll//lib/jekyll/utils/thread_event.rb#10
  def initialize; end

  # Returns the value of attribute flag.
  #
  # source://jekyll//lib/jekyll/utils/thread_event.rb#8
  def flag; end

  # source://jekyll//lib/jekyll/utils/thread_event.rb#16
  def set; end

  # source://jekyll//lib/jekyll/utils/thread_event.rb#24
  def wait; end
end

# source://jekyll//lib/jekyll/utils/win_tz.rb#5
module Jekyll::Utils::WinTZ
  ...
  #
  # source://jekyll//lib/jekyll/utils/win_tz.rb#14
  def calculate(timezone, now = T.unsafe(nil)); end
end

# source://jekyll//lib/jekyll/version.rb#4
Jekyll::VERSION = T.let(T.unsafe(nil), String)

# source://jekyll//lib/jekyll/converters/smartypants.rb#3
module Kramdown
  class << self
...
#
# source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#9
class Kramdown::JekyllDocument < ::Kramdown::Document
  # @return [JekyllDocument] a new instance of JekyllDocument
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#50
  ...
  #
  # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#61
  def to_html; end

  class << self
    # Returns the value of attribute options.
    #
    # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#11
    def options; end
    ...
    #
    #
    # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#16
    def setup(options); end

    private

    # source://jekyll//lib/jekyll/converters/markdown/kramdown_parser.rb#43
    def try_require(type, name); end
  end
end

# source://jekyll//lib/jekyll/converters/smartypants.rb#4
module Kramdown::Parser; end

# source://jekyll//lib/jekyll/converters/smartypants.rb#5
class Kramdown::Parser::SmartyPants < ::Kramdown::Parser::Kramdown
  # @return [SmartyPants] a new instance of SmartyPants
  #
  # source://jekyll//lib/jekyll/converters/smartypants.rb#6
  def initialize(source, options); end

  # source://jekyll//lib/jekyll/converters/smartypants.rb#12
...
class Object < ::BasicObject
  ...
  # source://jekyll//lib/jekyll.rb#10
