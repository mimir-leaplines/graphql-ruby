...
# source://forwardable-extended//lib/forwardable/extended/version.rb#6
module Forwardable::Extended
  # ------------------------------------------------------------------------
  # Wraps around traditional delegation and modern delegation.
  # ------------------------------------------------------------------------
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#135
  ...
  # ------------------------------------------------------------------------
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#159
  ...
  # ------------------------------------------------------------------------
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#40
  ...
  # ------------------------------------------------------------------------
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#71
  ...
  # ------------------------------------------------------------------------
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#102
  ...
  # @raise [ArgumentError]
  #
  # source://forwardable-extended//lib/forwardable/extended.rb#29
  def rb_delegate(method, to: T.unsafe(nil), alias_of: T.unsafe(nil), **kwd); end

  private

  # source://forwardable-extended//lib/forwardable/extended.rb#187
  def delegate_debug(str); end

  # source://forwardable-extended//lib/forwardable/extended.rb#174
  ...
  class << self
    ...
    # ------------------------------------------------------------------------
    #
    # source://forwardable-extended//lib/forwardable/extended.rb#17
    def extended(klass); end
  end
end

# source://forwardable-extended//lib/forwardable/extended/version.rb#7
