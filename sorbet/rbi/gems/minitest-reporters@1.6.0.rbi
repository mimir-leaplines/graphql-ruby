...
module Minitest
  class << self
    # source://minitest/5.9.1/lib/minitest.rb#149
    def __run(reporter, options); end

    # source://minitest/5.9.1/lib/minitest.rb#73
    def after_run(&block); end

    # source://minitest/5.9.1/lib/minitest.rb#51
    def autorun; end

    # source://minitest/5.9.1/lib/minitest.rb#28
    def backtrace_filter; end

    # source://minitest/5.9.1/lib/minitest.rb#28
    def backtrace_filter=(_arg0); end

    # source://minitest/5.9.1/lib/minitest.rb#805
    def clock_time; end

    # source://minitest/5.9.1/lib/minitest.rb#40
    def extensions; end

    # source://minitest/5.9.1/lib/minitest.rb#40
    def extensions=(_arg0); end

    # source://minitest/5.9.1/lib/minitest.rb#232
    def filter_backtrace(bt); end

    # source://minitest/5.9.1/lib/minitest.rb#45
    def info_signal; end

    # source://minitest/5.9.1/lib/minitest.rb#45
    def info_signal=(_arg0); end

    # source://minitest/5.9.1/lib/minitest.rb#77
    def init_plugins(options); end

    # source://minitest/5.9.1/lib/minitest.rb#84
    def load_plugins; end

    # source://minitest/5.9.1/lib/minitest.rb#22
    def parallel_executor; end

    # source://minitest/5.9.1/lib/minitest.rb#22
    def parallel_executor=(_arg0); end

    # source://minitest/5.9.1/lib/minitest.rb#162
    def process_args(args = T.unsafe(nil)); end

    # source://minitest/5.9.1/lib/minitest.rb#35
    def reporter; end

    # source://minitest/5.9.1/lib/minitest.rb#35
    def reporter=(_arg0); end

    # source://minitest/5.9.1/lib/minitest.rb#119
    def run(args = T.unsafe(nil)); end

    # source://minitest/5.9.1/lib/minitest.rb#798
