...
# source://pathutil//lib/pathutil/helpers.rb#5
class Pathutil
  ...
  # @return Pathutil
  #
  # source://pathutil//lib/pathutil.rb#19
  ...
  # @return true|false
  #
  # source://pathutil//lib/pathutil.rb#171
  def <(other); end
  ...
  # @return true|false
  #
  # source://pathutil//lib/pathutil.rb#183
  def <=(other); end
  ...
  #
  # source://pathutil//lib/pathutil.rb#139
  def ===(other); end
  ...
  # @return true|false
  #
  # source://pathutil//lib/pathutil.rb#160
  def >(other); end
  ...
  # @return true|false
  #
  # source://pathutil//lib/pathutil.rb#149
  def >=(other); end
  ...
  # --
  #
  # source://pathutil//lib/pathutil.rb#38
  def absolute; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#194
  def absolute?; end

  # --
  # --
  #
  # source://pathutil//lib/pathutil.rb#610
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#207
  def ascend; end
  ...
  # @return String
  #
  # source://pathutil//lib/pathutil.rb#513
  ...
  # @note You can set the default encodings via the class.
  #
  # source://pathutil//lib/pathutil.rb#573
  ...
  # @yield &block
  #
  # source://pathutil//lib/pathutil.rb#355
  def chdir; end
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#307
  def children; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#50
  ...
  # --
  #
  # source://pathutil//lib/pathutil.rb#633
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#237
  def descend; end
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#385
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#257
  def each_line; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#482
  def encoding; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#10
  ...
  # @return Pathutil
  #
  # source://pathutil//lib/pathutil.rb#440
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#373
  def find; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#273
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#331
  ...
  # @return [Boolean] true|false
  #
  # source://pathutil//lib/pathutil.rb#290
  def in_path?(path); end

  # --
  #
  # source://pathutil//lib/pathutil.rb#298
  def inspect; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#473
  def normalize; end
  ...
  # @return Pathutil
  #
  # source://pathutil//lib/pathutil.rb#397
  def parent; end
  ...
  # @return String
  #
  # source://pathutil//lib/pathutil.rb#493
  ...
  #
  # source://pathutil//lib/pathutil.rb#111
  ...
  #
  # source://pathutil//lib/pathutil.rb#95
  ...
  # @note You can set the default encodings via the class.
  #
  # source://pathutil//lib/pathutil.rb#533
  ...
  # --
  #
  # source://pathutil//lib/pathutil.rb#28
  def relative; end
  ...
  # @return Pathutil
  #
  # source://pathutil//lib/pathutil.rb#429
  ...
  # @return [Boolean] true|false
  #
  # source://pathutil//lib/pathutil.rb#282
  def root?; end
  ...
  # @return nil
  #
  # source://pathutil//lib/pathutil.rb#453
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#61
  ...
  # @yield Pathutil
  #
  # source://pathutil//lib/pathutil.rb#409
  def split; end
  ...
  #
  # source://pathutil//lib/pathutil.rb#128
  def split_path; end
  ...
  # --
  #
  # source://pathutil//lib/pathutil.rb#598
  ...
  # @return Pathutil
  #
  # source://pathutil//lib/pathutil.rb#420
  def sub_ext(ext); end
  ...
  # --
  #
  # source://pathutil//lib/pathutil.rb#589
  ...
  # @note You can set the default encodings via the class.
  #
  # source://pathutil//lib/pathutil.rb#553
  ...
  # source://pathutil//lib/pathutil.rb#663
  def expanded_paths(path); end

  # source://pathutil//lib/pathutil.rb#682
  def safe_copy_directory(to, root: T.unsafe(nil), ignore: T.unsafe(nil)); end

  # @raise [Errno::EPERM]
  #
  # source://pathutil//lib/pathutil.rb#671
  ...
  class << self
    ...
    # @return Pathutil
    #
    # source://pathutil//lib/pathutil.rb#723
    def cwd; end
    ...
    #
    # source://pathutil//lib/pathutil.rb#737
    def encoding; end
    ...
    # @param value the value to set the attribute encoding to.
    #
    # source://pathutil//lib/pathutil.rb#716
    def encoding=(_arg0); end
    ...
    # --
    #
    # source://pathutil//lib/pathutil.rb#747
    def normalize; end
    ...
    # @return Pathutil
    #
    # source://pathutil//lib/pathutil.rb#760
    def tmpdir(*args); end
    ...
    # @return Pathutil
    #
    # source://pathutil//lib/pathutil.rb#775
...
# source://pathutil//lib/pathutil/helpers.rb#6
module Pathutil::Helpers
  extend ::Pathutil::Helpers

  # --
  #
  # source://pathutil//lib/pathutil/helpers.rb#11
  def allowed; end
  ...
  # @return Hash
  #
  # source://pathutil//lib/pathutil/helpers.rb#27
  ...
  # @return String
  #
  # source://pathutil//lib/pathutil/helpers.rb#57
  def make_tmpname(prefix = T.unsafe(nil), suffix = T.unsafe(nil), root = T.unsafe(nil)); end

  private

  # source://pathutil//lib/pathutil/helpers.rb#69
  def __make_tmpname(_arg0, number); end

  # source://pathutil//lib/pathutil/helpers.rb#118
  def setup_safe_yaml(whitelist_classes, aliases); end

  # @raise [ArgumentError]
  #
  # source://pathutil//lib/pathutil/helpers.rb#81
  def tmpname_agerr(type, val); end

  # source://pathutil//lib/pathutil/helpers.rb#98
  def tmpname_prefix(prefix); end

  # source://pathutil//lib/pathutil/helpers.rb#87
