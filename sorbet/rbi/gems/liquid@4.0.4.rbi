...
# source://liquid//lib/liquid/extensions.rb#16
class Array
  include ::Enumerable

  # source://liquid//lib/liquid/extensions.rb#17
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#52
class Date
  include ::Comparable

  # source://liquid//lib/liquid/extensions.rb#53
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#46
class DateTime < ::Date
  # source://liquid//lib/liquid/extensions.rb#47
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#64
class FalseClass
  # source://liquid//lib/liquid/extensions.rb#65
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#22
class Hash
  include ::Enumerable

  # source://liquid//lib/liquid/extensions.rb#23
  def to_liquid; end
end

# source://liquid//lib/liquid.rb#22
module Liquid
  class << self
...
# source://liquid//lib/liquid/errors.rb#41
...
#  {{ foo }}
#
# source://liquid//lib/liquid/tags/assign.rb#10
class Liquid::Assign < ::Liquid::Tag
  # @return [Assign] a new instance of Assign
  #
  # source://liquid//lib/liquid/tags/assign.rb#15
  ...
  # source://liquid//lib/liquid/tags/assign.rb#25
  ...
  # source://liquid//lib/liquid/tags/assign.rb#38
  def assign_score_of(val); end
end

# source://liquid//lib/liquid/tags/assign.rb#51
class Liquid::Assign::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/assign.rb#52
  def children; end
end

# source://liquid//lib/liquid/tags/assign.rb#11
...
#
# source://liquid//lib/liquid/file_system.rb#15
...
# source://liquid//lib/liquid/block.rb#2
class Liquid::Block < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/block.rb#46
  def block_delimiter; end

  # source://liquid//lib/liquid/block.rb#42
  def block_name; end

  # source://liquid//lib/liquid/block.rb#24
  def nodelist; end

  # source://liquid//lib/liquid/block.rb#10
  def parse(tokens); end

  # source://liquid//lib/liquid/block.rb#16
  def render(context); end
  ...
  # source://liquid//lib/liquid/block.rb#52
  def parse_body(body, tokens); end
end

# source://liquid//lib/liquid/block.rb#3
Liquid::Block::MAX_DEPTH = T.let(T.unsafe(nil), Integer)

# source://liquid//lib/liquid/block_body.rb#2
class Liquid::BlockBody
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/block_body.rb#65
  def blank?; end
  ...
  # source://liquid//lib/liquid/block_body.rb#55
...
# source://liquid//lib/liquid/block_body.rb#5
...
#    {% endfor %}
#
# source://liquid//lib/liquid/tags/break.rb#11
class Liquid::Break < ::Liquid::Tag
  # source://liquid//lib/liquid/tags/break.rb#12
  def interrupt; end
end

# Interrupt that is thrown whenever a {% break %} is called.
#
# source://liquid//lib/liquid/interrupts.rb#12
...
#
# source://liquid//lib/liquid/tags/capture.rb#13
class Liquid::Capture < ::Liquid::Block
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/capture.rb#32
  def blank?; end
...
# source://liquid//lib/liquid/tags/capture.rb#14
Liquid::Capture::Syntax = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/tags/case.rb#2
class Liquid::Case < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/case.rb#19
  def parse(tokens); end

  # source://liquid//lib/liquid/tags/case.rb#41
  def render(context); end

  # source://liquid//lib/liquid/tags/case.rb#30
  def unknown_tag(tag, markup, tokens); end

  private

  # source://liquid//lib/liquid/tags/case.rb#76
  def record_else_condition(markup); end

  # source://liquid//lib/liquid/tags/case.rb#60
  def record_when_condition(markup); end
end

# source://liquid//lib/liquid/tags/case.rb#86
class Liquid::Case::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/case.rb#87
  def children; end
end

# source://liquid//lib/liquid/tags/case.rb#3
...
# source://liquid//lib/liquid/tags/comment.rb#2
class Liquid::Comment < ::Liquid::Block
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/comment.rb#10
  def blank?; end

  # source://liquid//lib/liquid/tags/comment.rb#3
  def render(_context); end

  # source://liquid//lib/liquid/tags/comment.rb#7
...
#   c.evaluate #=> true
#
# source://liquid//lib/liquid/condition.rb#9
class Liquid::Condition
  # @return [Condition] a new instance of Condition
  #
  # source://liquid//lib/liquid/condition.rb#35
  ...
  # source://liquid//lib/liquid/condition.rb#72
  def attach(attachment); end

  # Returns the value of attribute attachment.
  #
  # source://liquid//lib/liquid/condition.rb#32
  def attachment; end
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/condition.rb#76
  def else?; end

  # source://liquid//lib/liquid/condition.rb#43
  def evaluate(context = T.unsafe(nil)); end

  # source://liquid//lib/liquid/condition.rb#80
  def inspect; end
  ...
  # source://liquid//lib/liquid/condition.rb#62
  ...
  # source://liquid//lib/liquid/condition.rb#90
  ...
  class << self
    # source://liquid//lib/liquid/condition.rb#28
    def operators; end
  end
end

# source://liquid//lib/liquid/condition.rb#132
class Liquid::Condition::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/condition.rb#133
  def children; end
end
...
#
# source://liquid//lib/liquid/context.rb#14
class Liquid::Context
  ...
  #
  # source://liquid//lib/liquid/context.rb#150
  def [](expression); end

  # Only allow String, Numeric, Hash, Array, Proc, Boolean or <tt>Liquid::Drop</tt>
  #
  # source://liquid//lib/liquid/context.rb#134
  def []=(key, value); end
  ...
  # source://liquid//lib/liquid/context.rb#158
  ...
  #
  # source://liquid//lib/liquid/context.rb#163
  ...
  # source://liquid//lib/liquid/context.rb#85
  def invoke(method, *args); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/context.rb#154
  def key?(key); end

  # source://liquid//lib/liquid/context.rb#192
  ...
  # @raise [ContextError]
  #
  # source://liquid//lib/liquid/context.rb#101
  def pop; end

  # pop an interrupt from the stack
  #
  # source://liquid//lib/liquid/context.rb#73
  ...
  #
  # source://liquid//lib/liquid/context.rb#90
  def push(new_scope = T.unsafe(nil)); end

  # push an interrupt to the stack. this interrupt is considered not handled.
  #
  # source://liquid//lib/liquid/context.rb#68
  ...
  # source://liquid//lib/liquid/context.rb#44
  def strainer; end
  ...
  # source://liquid//lib/liquid/context.rb#40
  def warnings; end

  private

  # source://liquid//lib/liquid/context.rb#208
  def internal_error; end

  # source://liquid//lib/liquid/context.rb#215
  def squash_instance_assigns_with_environments; end
end

# source://liquid//lib/liquid/errors.rb#42
...
#    {% endfor %}
#
# source://liquid//lib/liquid/tags/continue.rb#11
...
#
# source://liquid//lib/liquid/interrupts.rb#15
...
#
# source://liquid//lib/liquid/tags/cycle.rb#14
class Liquid::Cycle < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/cycle.rb#34
  def render(context); end
  ...
  # source://liquid//lib/liquid/tags/cycle.rb#50
...
# source://liquid//lib/liquid/tags/cycle.rb#57
class Liquid::Cycle::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/cycle.rb#58
  def children; end
end

# source://liquid//lib/liquid/tags/cycle.rb#15
...
#    Hello: -3
#
# source://liquid//lib/liquid/tags/decrement.rb#20
...
# source://liquid//lib/liquid/document.rb#2
class Liquid::Document < ::Liquid::BlockBody
  # source://liquid//lib/liquid/document.rb#9
  ...
  class << self
    # source://liquid//lib/liquid/document.rb#3
    def parse(tokens, parse_context); end
  end
end
...
#
# source://liquid//lib/liquid/drop.rb#23
class Liquid::Drop
  ...
  #
  # source://liquid//lib/liquid/drop.rb#24
  def context=(_arg0); end

  # source://liquid//lib/liquid/drop.rb#45
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/drop.rb#41
  def key?(_name); end
  ...
  #
  # source://liquid//lib/liquid/drop.rb#27
  def liquid_method_missing(method); end

  # source://liquid//lib/liquid/drop.rb#49
  def to_liquid; end

  # source://liquid//lib/liquid/drop.rb#53
  def to_s; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://liquid//lib/liquid/drop.rb#60
    def invokable?(method_name); end

    # source://liquid//lib/liquid/drop.rb#64
    def invokable_methods; end
  end
end

# source://liquid//lib/liquid/condition.rb#142
class Liquid::ElseCondition < ::Liquid::Condition
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/condition.rb#143
  def else?; end

  # source://liquid//lib/liquid/condition.rb#147
  def evaluate(_context); end
end

# source://liquid//lib/liquid/errors.rb#2
class Liquid::Error < ::StandardError
  # Returns the value of attribute line_number.
  #
  # source://liquid//lib/liquid/errors.rb#3
  def line_number; end
  ...
  # source://liquid//lib/liquid/errors.rb#22
  def message_prefix; end
end

# source://liquid//lib/liquid/expression.rb#2
class Liquid::Expression
  class << self
    # source://liquid//lib/liquid/expression.rb#30
    def parse(markup); end
  end
end

# source://liquid//lib/liquid/expression.rb#25
...
class Liquid::Expression::MethodLiteral
  ...
  # source://liquid//lib/liquid/expression.rb#11
  def to_liquid; end
...
# source://liquid//lib/liquid/expression.rb#24
...
# source://liquid//lib/liquid.rb#23
...
#
# source://liquid//lib/liquid/tags/for.rb#46
class Liquid::For < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/for.rb#64
  def nodelist; end

  # source://liquid//lib/liquid/tags/for.rb#59
  def parse(tokens); end

  # source://liquid//lib/liquid/tags/for.rb#73
  def render(context); end

  # source://liquid//lib/liquid/tags/for.rb#68
  def unknown_tag(tag, markup, tokens); end
  ...
  # source://liquid//lib/liquid/tags/for.rb#85
  def lax_parse(markup); end

  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/for.rb#100
  def strict_parse(markup); end

  private

  # source://liquid//lib/liquid/tags/for.rb#121
  def collection_segment(context); end

  # source://liquid//lib/liquid/tags/for.rb#191
  def render_else(context); end

  # source://liquid//lib/liquid/tags/for.rb#144
  def render_segment(context, segment); end

  # source://liquid//lib/liquid/tags/for.rb#178
  def set_attribute(key, expr); end
end

# source://liquid//lib/liquid/tags/for.rb#195
class Liquid::For::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/for.rb#196
  def children; end
end

# source://liquid//lib/liquid/tags/for.rb#47
Liquid::For::Syntax = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/forloop_drop.rb#2
class Liquid::ForloopDrop < ::Liquid::Drop
  # @return [ForloopDrop] a new instance of ForloopDrop
  #
  # source://liquid//lib/liquid/forloop_drop.rb#3
  def initialize(name, length, parentloop); end

  # source://liquid//lib/liquid/forloop_drop.rb#28
  def first; end

  # source://liquid//lib/liquid/forloop_drop.rb#12
  def index; end

  # source://liquid//lib/liquid/forloop_drop.rb#16
  def index0; end

  # source://liquid//lib/liquid/forloop_drop.rb#32
  def last; end
  ...
  # source://liquid//lib/liquid/forloop_drop.rb#20
  def rindex; end

  # source://liquid//lib/liquid/forloop_drop.rb#24
  def rindex0; end

  protected

  # source://liquid//lib/liquid/forloop_drop.rb#38
  def increment!; end
end

# source://liquid//lib/liquid/i18n.rb#4
class Liquid::I18n
  ...
  # source://liquid//lib/liquid/i18n.rb#15
  ...
  # source://liquid//lib/liquid/i18n.rb#33
  def deep_fetch_translation(name); end

  # source://liquid//lib/liquid/i18n.rb#26
  def interpolate(name, vars); end
end

# source://liquid//lib/liquid/i18n.rb#5
...
#
# source://liquid//lib/liquid/tags/if.rb#12
class Liquid::If < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/if.rb#25
  def nodelist; end
  ...
  # source://liquid//lib/liquid/tags/if.rb#34
  def unknown_tag(tag, markup, tokens); end
  ...
  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/if.rb#66
  def lax_parse(markup); end

  # source://liquid//lib/liquid/tags/if.rb#93
  def parse_binary_comparisons(p); end

  # source://liquid//lib/liquid/tags/if.rb#104
  def parse_comparison(p); end

  # source://liquid//lib/liquid/tags/if.rb#55
  def push_block(tag, markup); end

  # source://liquid//lib/liquid/tags/if.rb#86
  def strict_parse(markup); end
end
...
#
# source://liquid//lib/liquid/tags/include.rb#16
class Liquid::Include < ::Liquid::Tag
  ...
  #
  # source://liquid//lib/liquid/tags/include.rb#19
  def attributes; end

  # source://liquid//lib/liquid/tags/include.rb#42
  def parse(_tokens); end

  # @raise [ArgumentError]
  #
  # source://liquid//lib/liquid/tags/include.rb#45
  def render(context); end
  ...
  # source://liquid//lib/liquid/tags/include.rb#89
  def load_cached_partial(template_name, context); end

  # source://liquid//lib/liquid/tag.rb#3
...
# source://liquid//lib/liquid/tags/include.rb#113
class Liquid::Include::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/include.rb#114
  def children; end
end

# source://liquid//lib/liquid/tags/include.rb#17
...
#    Hello: 2
#
# source://liquid//lib/liquid/tags/increment.rb#17
class Liquid::Increment < ::Liquid::Tag
  # @return [Increment] a new instance of Increment
  #
  # source://liquid//lib/liquid/tags/increment.rb#18
  def initialize(tag_name, markup, options); end

  # source://liquid//lib/liquid/tags/increment.rb#23
  def render(context); end
end
...
#
# source://liquid//lib/liquid/interrupts.rb#3
class Liquid::Interrupt
  ...
  #
  # source://liquid//lib/liquid/interrupts.rb#4
  def message; end
end

# source://liquid//lib/liquid/lexer.rb#3
class Liquid::Lexer
...
#
# source://liquid//lib/liquid/file_system.rb#44
class Liquid::LocalFileSystem
  ...
  # @raise [FileSystemError]
  #
  # source://liquid//lib/liquid/file_system.rb#59
  def full_path(template_path); end

  # @raise [FileSystemError]
  #
  # source://liquid//lib/liquid/file_system.rb#52
  def read_template_file(template_path); end

  # Returns the value of attribute root.
  #
  # source://liquid//lib/liquid/file_system.rb#45
  def root; end
...
# source://liquid//lib/liquid/parse_context.rb#2
class Liquid::ParseContext
  ...
  # source://liquid//lib/liquid/parse_context.rb#14
  def [](option_key); end

  # Returns the value of attribute depth.
  #
  # source://liquid//lib/liquid/parse_context.rb#3
  def depth; end
  ...
  # source://liquid//lib/liquid/parse_context.rb#25
...
# source://liquid//lib/liquid/parser.rb#2
class Liquid::Parser
  # @return [Parser] a new instance of Parser
  #
  # source://liquid//lib/liquid/parser.rb#3
  def initialize(input); end

  # source://liquid//lib/liquid/parser.rb#65
  def argument; end

  # source://liquid//lib/liquid/parser.rb#13
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/parser.rb#25
  def consume?(type); end

  # source://liquid//lib/liquid/parser.rb#47
  def expression; end
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/parser.rb#33
  def id?(str); end

  # source://liquid//lib/liquid/parser.rb#9
  def jump(point); end

  # source://liquid//lib/liquid/parser.rb#41
  def look(type, ahead = T.unsafe(nil)); end

  # source://liquid//lib/liquid/parser.rb#76
  def variable_signature; end
end

# source://liquid//lib/liquid/parser_switching.rb#2
module Liquid::ParserSwitching
  # source://liquid//lib/liquid/parser_switching.rb#3
  def parse_with_selected_parser(markup); end

  private

  # source://liquid//lib/liquid/parser_switching.rb#27
  def markup_context(markup); end

  # source://liquid//lib/liquid/parser_switching.rb#19
...
# source://liquid//lib/liquid/range_lookup.rb#2
class Liquid::RangeLookup
  # @return [RangeLookup] a new instance of RangeLookup
  #
  # source://liquid//lib/liquid/range_lookup.rb#13
  def initialize(start_obj, end_obj); end

  # source://liquid//lib/liquid/range_lookup.rb#18
  def evaluate(context); end

  private

  # source://liquid//lib/liquid/range_lookup.rb#26
  def to_integer(input); end

  class << self
    # source://liquid//lib/liquid/range_lookup.rb#3
    def parse(start_markup, end_markup); end
  end
end

# source://liquid//lib/liquid/tags/raw.rb#2
class Liquid::Raw < ::Liquid::Block
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/raw.rb#33
  def blank?; end

  # source://liquid//lib/liquid/tags/raw.rb#29
  def nodelist; end

  # @raise [SyntaxError]
  #
  # source://liquid//lib/liquid/tags/raw.rb#12
  def parse(tokens); end
  ...
  # source://liquid//lib/liquid/tags/raw.rb#39
...
# source://liquid//lib/liquid/tags/raw.rb#3
Liquid::Raw::Syntax = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/resource_limits.rb#2
class Liquid::ResourceLimits
  ...
  #
  # source://liquid//lib/liquid/resource_limits.rb#3
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/resource_limits.rb#13
  def reached?; end
  ...
  # source://liquid//lib/liquid/resource_limits.rb#19
  def reset; end
end
...
# source://liquid//lib/liquid/standardfilters.rb#5
module Liquid::StandardFilters
  # absolute value
  #
  # source://liquid//lib/liquid/standardfilters.rb#352
  def abs(input); end

  # add one string to another
  #
  # source://liquid//lib/liquid/standardfilters.rb#273
  def append(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#406
  def at_least(input, n); end

  # source://liquid//lib/liquid/standardfilters.rb#414
  def at_most(input, n); end

  # capitalize words in the input centence
  #
  # source://liquid//lib/liquid/standardfilters.rb#37
  def capitalize(input); end

  # source://liquid//lib/liquid/standardfilters.rb#394
  def ceil(input); end
  ...
  # source://liquid//lib/liquid/standardfilters.rb#277
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#325
  def date(input, format); end

  # source://liquid//lib/liquid/standardfilters.rb#422
  def default(input, default_value = T.unsafe(nil)); end

  # division
  #
  # source://liquid//lib/liquid/standardfilters.rb#373
  def divided_by(input, operand); end

  # convert an input string to DOWNCASE
  #
  # source://liquid//lib/liquid/standardfilters.rb#27
  def downcase(input); end

  # source://liquid//lib/liquid/standardfilters.rb#41
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#338
  def first(array); end

  # source://liquid//lib/liquid/standardfilters.rb#400
  def floor(input); end
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#128
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#347
  def last(array); end

  # source://liquid//lib/liquid/standardfilters.rb#107
  def lstrip(input); end

  # map/collect on a given property
  #
  # source://liquid//lib/liquid/standardfilters.rb#219
  def map(input, property); end

  # subtraction
  #
  # source://liquid//lib/liquid/standardfilters.rb#363
  def minus(input, operand); end

  # source://liquid//lib/liquid/standardfilters.rb#379
  ...
  # addition
  #
  # source://liquid//lib/liquid/standardfilters.rb#358
  def plus(input, operand); end

  # prepend a string to another
  #
  # source://liquid//lib/liquid/standardfilters.rb#285
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#268
  def remove_first(input, string); end

  # Replace occurrences of a string with another
  #
  # source://liquid//lib/liquid/standardfilters.rb#253
  def replace(input, string, replacement = T.unsafe(nil)); end

  # Replace the first occurrences of a string with another
  #
  # source://liquid//lib/liquid/standardfilters.rb#258
  def replace_first(input, string, replacement = T.unsafe(nil)); end

  # Reverse the elements of an array
  #
  # source://liquid//lib/liquid/standardfilters.rb#213
  def reverse(input); end

  # source://liquid//lib/liquid/standardfilters.rb#385
  def round(input, n = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#111
  def rstrip(input); end

  # Return the size of an array or of an string
  #
  # source://liquid//lib/liquid/standardfilters.rb#22
  def size(input); end

  # source://liquid//lib/liquid/standardfilters.rb#63
  ...
  # provide optional property with which to sort an array of hashes or drops
  #
  # source://liquid//lib/liquid/standardfilters.rb#154
  ...
  #
  # source://liquid//lib/liquid/standardfilters.rb#99
  def split(input, pattern); end

  # source://liquid//lib/liquid/standardfilters.rb#103
  def strip(input); end

  # source://liquid//lib/liquid/standardfilters.rb#115
  def strip_html(input); end

  # Remove all newlines from the string
  #
  # source://liquid//lib/liquid/standardfilters.rb#123
  ...
  # source://liquid//lib/liquid/standardfilters.rb#50
  def url_encode(input); end

  # Filter the elements of an array to those with a certain property value.
  # By default the target is any truthy value.
  #
  # source://liquid//lib/liquid/standardfilters.rb#174
  def where(input, property, target_value = T.unsafe(nil)); end

  private

  # source://liquid//lib/liquid/standardfilters.rb#436
  ...
  # source://liquid//lib/liquid/standardfilters.rb#441
  def nil_safe_compare(a, b); end

  # @raise [Liquid::ArgumentError]
  #
  # source://liquid//lib/liquid/standardfilters.rb#432
  def raise_property_error(property); end
end

# source://liquid//lib/liquid/standardfilters.rb#6
...
# source://liquid//lib/liquid/standardfilters.rb#457
class Liquid::StandardFilters::InputIterator
  ...
  # source://liquid//lib/liquid/standardfilters.rb#476
  def concat(args); end
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/standardfilters.rb#492
  def empty?; end

  # source://liquid//lib/liquid/standardfilters.rb#472
  def join(glue); end

  # source://liquid//lib/liquid/standardfilters.rb#480
  def reverse; end

  # source://liquid//lib/liquid/standardfilters.rb#484
  def uniq(&block); end
end

# source://liquid//lib/liquid/standardfilters.rb#14
Liquid::StandardFilters::STRIP_HTML_BLOCKS = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/standardfilters.rb#19
...
#
# source://liquid//lib/liquid/strainer.rb#9
class Liquid::Strainer
  # @return [Strainer] a new instance of Strainer
  #
  # source://liquid//lib/liquid/strainer.rb#20
  def initialize(context); end

  # source://liquid//lib/liquid/strainer.rb#54
  def invoke(method, *args); end

  class << self
    # @raise [ArgumentError]
    #
    # source://liquid//lib/liquid/strainer.rb#28
    def add_filter(filter); end

    # source://liquid//lib/liquid/strainer.rb#50
    def create(context, filters = T.unsafe(nil)); end

    # Returns the value of attribute filter_methods.
    #
    # source://liquid//lib/liquid/strainer.rb#25
    def filter_methods; end

    # source://liquid//lib/liquid/strainer.rb#41
    def global_filter(filter); end

    # @return [Boolean]
    #
    # source://liquid//lib/liquid/strainer.rb#46
...
# source://liquid//lib/liquid/tags/table_row.rb#2
class Liquid::TableRow < ::Liquid::Block
  ...
  # source://liquid//lib/liquid/tags/table_row.rb#21
  def render(context); end
...
# source://liquid//lib/liquid/tags/table_row.rb#54
class Liquid::TableRow::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/table_row.rb#55
  def children; end
end

# source://liquid//lib/liquid/tags/table_row.rb#3
Liquid::TableRow::Syntax = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/tablerowloop_drop.rb#2
class Liquid::TablerowloopDrop < ::Liquid::Drop
  # @return [TablerowloopDrop] a new instance of TablerowloopDrop
  #
  # source://liquid//lib/liquid/tablerowloop_drop.rb#3
  def initialize(length, cols); end

  # Returns the value of attribute col.
  #
  # source://liquid//lib/liquid/tablerowloop_drop.rb#11
  def col; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#21
  def col0; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#41
  def col_first; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#45
  def col_last; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#33
  def first; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#13
  def index; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#17
  def index0; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#37
  def last; end
  ...
  # source://liquid//lib/liquid/tablerowloop_drop.rb#25
  def rindex; end

  # source://liquid//lib/liquid/tablerowloop_drop.rb#29
  def rindex0; end
  ...
  # source://liquid//lib/liquid/tablerowloop_drop.rb#51
  def increment!; end
end

# source://liquid//lib/liquid/tag.rb#2
class Liquid::Tag
  include ::Liquid::ParserSwitching

  # @return [Tag] a new instance of Tag
  #
  # source://liquid//lib/liquid/tag.rb#17
  def initialize(tag_name, markup, parse_context); end
  ...
  # source://liquid//lib/liquid/tag.rb#31
  def name; end
  ...
  # source://liquid//lib/liquid/tag.rb#24
  def parse(_tokens); end
  ...
  # source://liquid//lib/liquid/tag.rb#27
  def raw; end
...
#
# source://liquid//lib/liquid/template.rb#15
class Liquid::Template
  ...
  # source://liquid//lib/liquid/template.rb#139
  def assigns; end

  # source://liquid//lib/liquid/template.rb#147
  def errors; end

  # source://liquid//lib/liquid/template.rb#143
  def instance_assigns; end

  # Parse source code.
  # Returns self for easy chaining
  #
  # source://liquid//lib/liquid/template.rb#125
  ...
  # source://liquid//lib/liquid/template.rb#135
  def registers; end
  ...
  #
  # source://liquid//lib/liquid/template.rb#165
  def render(*args); end

  # source://liquid//lib/liquid/template.rb#216
  def render!(*args); end
  ...
  # Returns the value of attribute root.
  #
  # source://liquid//lib/liquid/template.rb#16
  def root; end
  ...
  # source://liquid//lib/liquid/template.rb#244
  def apply_options_to_context(context, options); end

  # source://liquid//lib/liquid/template.rb#223
  def tokenize(source); end

  # source://liquid//lib/liquid/template.rb#227
  def with_profiling(context); end

  class << self
    # Returns the value of attribute default_exception_renderer.
    #
    # source://liquid//lib/liquid/template.rb#69
    ...
    # source://liquid//lib/liquid/template.rb#105
    ...
    # source://liquid//lib/liquid/template.rb#74
    def file_system; end

    # source://liquid//lib/liquid/template.rb#78
    ...
    #
    # source://liquid//lib/liquid/template.rb#112
    def parse(source, options = T.unsafe(nil)); end
    ...
    # source://liquid//lib/liquid/template.rb#82
    def register_tag(name, klass); end

    # source://liquid//lib/liquid/template.rb#86
    def tags; end

    # Deprecated. Removed in version 5
    #
    # source://liquid//lib/liquid/template.rb#95
    def taint_mode; end
...
# source://liquid//lib/liquid/tokenizer.rb#2
class Liquid::Tokenizer
  ...
  # Returns the value of attribute line_number.
  #
  # source://liquid//lib/liquid/tokenizer.rb#3
  def line_number; end
  ...
  # source://liquid//lib/liquid/tokenizer.rb#19
  def tokenize; end
end
...
#
# source://liquid//lib/liquid/tags/unless.rb#8
class Liquid::Unless < ::Liquid::If
  # source://liquid//lib/liquid/tags/unless.rb#9
  def render(context); end
end

# source://liquid//lib/liquid/utils.rb#2
module Liquid::Utils
  class << self
    # source://liquid//lib/liquid/utils.rb#3
    def slice_collection(collection, from, to); end

    # source://liquid//lib/liquid/utils.rb#11
    def slice_collection_using_each(collection, from, to); end

    # source://liquid//lib/liquid/utils.rb#63
    def to_date(obj); end

    # source://liquid//lib/liquid/utils.rb#36
    def to_integer(num); end

    # source://liquid//lib/liquid/utils.rb#46
    def to_number(obj); end
  end
end

# source://liquid//lib/liquid/version.rb#4
...
#   {{ user | link }}
#
# source://liquid//lib/liquid/variable.rb#12
class Liquid::Variable
  include ::Liquid::ParserSwitching

  # @return [Variable] a new instance of Variable
  #
  # source://liquid//lib/liquid/variable.rb#25
  ...
  # source://liquid//lib/liquid/variable.rb#42
  def lax_parse(markup); end
  ...
  # source://liquid//lib/liquid/variable.rb#38
  def markup_context(markup); end
  ...
  # Returns the value of attribute parse_context.
  #
  # source://liquid//lib/liquid/variable.rb#20
  def options; end
  ...
  # source://liquid//lib/liquid/variable.rb#73
  def parse_filterargs(p); end

  # source://liquid//lib/liquid/variable.rb#34
  def raw; end

  # source://liquid//lib/liquid/variable.rb#81
  def render(context); end

  # source://liquid//lib/liquid/variable.rb#60
  def strict_parse(markup); end
  ...
  # source://liquid//lib/liquid/variable.rb#92
...
# source://liquid//lib/liquid/variable.rb#13
...
class Liquid::Variable::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/variable.rb#120
  def children; end
end
...
# source://liquid//lib/liquid/variable_lookup.rb#2
class Liquid::VariableLookup
  # @return [VariableLookup] a new instance of VariableLookup
  #
  # source://liquid//lib/liquid/variable_lookup.rb#12
  def initialize(markup); end

  # source://liquid//lib/liquid/variable_lookup.rb#72
  def ==(other); end

  # source://liquid//lib/liquid/variable_lookup.rb#34
  def evaluate(context); end
  ...
  # source://liquid//lib/liquid/variable_lookup.rb#78
  def state; end
...
# source://liquid//lib/liquid/variable_lookup.rb#82
class Liquid::VariableLookup::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/variable_lookup.rb#83
  def children; end
end

# source://liquid//lib/liquid/variable_lookup.rb#3
...
# source://liquid//lib/liquid/extensions.rb#70
class NilClass
  # source://liquid//lib/liquid/extensions.rb#71
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#28
class Numeric
  include ::Comparable

  # source://liquid//lib/liquid/extensions.rb#29
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#34
class Range
  include ::Enumerable

  # source://liquid//lib/liquid/extensions.rb#35
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#4
class String
  include ::Comparable

  # source://liquid//lib/liquid/extensions.rb#5
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#10
class Symbol
  include ::Comparable

  # source://liquid//lib/liquid/extensions.rb#11
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#40
class Time
  include ::Comparable

  # source://liquid//lib/liquid/extensions.rb#41
  def to_liquid; end
end

# source://liquid//lib/liquid/extensions.rb#58
class TrueClass
  # source://liquid//lib/liquid/extensions.rb#59
  def to_liquid; end
end
