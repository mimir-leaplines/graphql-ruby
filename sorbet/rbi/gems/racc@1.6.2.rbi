...
class Racc::ActionTable
  ...
  #
  # source://racc//racc/state.rb#813
  def initialize(rt, st); end

  # Returns the value of attribute accept.
  #
  # source://racc//racc/state.rb#874
  def accept; end

  # source://racc//racc/state.rb#851
  def each_reduce(&block); end

  # source://racc//racc/state.rb#870
  def each_shift(&block); end

  # Returns the value of attribute error.
  #
  # source://racc//racc/state.rb#875
  def error; end

  # source://racc//racc/state.rb#823
  def init; end

  # source://racc//racc/state.rb#838
  def reduce(i); end

  # source://racc//racc/state.rb#834
  def reduce_n; end

  # source://racc//racc/state.rb#859
  def shift(i); end

  # source://racc//racc/state.rb#855
  def shift_n; end
end
...
class Racc::DebugFlags
  ...
  #
  # source://racc//racc/debugflags.rb#34
  ...
  # @return [Boolean]
  #
  # source://racc//racc/debugflags.rb#53
  def any?; end

  # Returns the value of attribute la.
  #
  # source://racc//racc/debugflags.rb#50
  def la; end

  # Returns the value of attribute parse.
  #
  # source://racc//racc/debugflags.rb#46
  def parse; end

  # Returns the value of attribute prec.
  #
  # source://racc//racc/debugflags.rb#51
  def prec; end

  # Returns the value of attribute rule.
  #
  # source://racc//racc/debugflags.rb#47
  def rule; end

  # Returns the value of attribute state.
  #
  # source://racc//racc/debugflags.rb#49
  def state; end

  # Returns the value of attribute status_logging.
  #
  # source://racc//racc/debugflags.rb#57
  def status_logging; end

  # Returns the value of attribute token.
  #
  # source://racc//racc/debugflags.rb#48
  def token; end

  class << self
    # source://racc//racc/debugflags.rb#16
    def parse_option_string(s); end
  end
end

class Racc::Error < ::StandardError
  # source://racc//racc/state.rb#931
  def inspect; end
end
...
class Racc::Goto
  ...
  #
  # source://racc//racc/state.rb#768
  def initialize(ident, sym, from, to); end

  # Returns the value of attribute from_state.
  #
  # source://racc//racc/state.rb#777
  def from_state; end

  # Returns the value of attribute ident.
  #
  # source://racc//racc/state.rb#775
  def ident; end

  # source://racc//racc/state.rb#780
  def inspect; end

  # Returns the value of attribute symbol.
  #
  # source://racc//racc/state.rb#776
  def symbol; end

  # Returns the value of attribute to_state.
  #
  # source://racc//racc/state.rb#778
  def to_state; end
end
...
class Racc::Grammar
  ...
  #
  # source://racc//racc/grammar.rb#24
  def initialize(debug_flags = T.unsafe(nil)); end

  # source://racc//racc/grammar.rb#40
  def [](x); end
  ...
  # @raise [ArgumentError]
  #
  # source://racc//racc/grammar.rb#166
  def add(rule); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#171
  def added?(sym); end

  # @raise [CompileError]
  #
  # source://racc//racc/grammar.rb#180
  def declare_precedence(assoc, syms); end

  # source://racc//racc/grammar.rb#120
  def dfa; end

  # source://racc//racc/grammar.rb#44
  def each(&block); end

  # source://racc//racc/grammar.rb#50
  ...
  # source://racc//racc/grammar.rb#92
  def each_useless_nonterminal; end

  # source://racc//racc/grammar.rb#108
  def each_useless_rule; end

  # source://racc//racc/grammar.rb#54
  def each_with_index(&block); end

  # source://racc//racc/grammar.rb#185
  ...
  # source://racc//racc/grammar.rb#88
  def n_useless_nonterminals; end

  # source://racc//racc/grammar.rb#104
  def n_useless_rules; end

  # source://racc//racc/grammar.rb#116
  def nfa; end

  # source://racc//racc/grammar.rb#80
  def nonterminal_base; end

  # source://racc//racc/grammar.rb#130
  def parser_class; end

  # source://racc//racc/grammar.rb#58
  def size; end

  # Returns the value of attribute start.
  #
  # source://racc//racc/grammar.rb#36
  def start; end

  # @raise [CompileError]
  #
  # source://racc//racc/grammar.rb#175
  def start_symbol=(s); end

  # source://racc//racc/grammar.rb#126
  def state_transition_table; end

  # source://racc//racc/grammar.rb#120
  def states; end

  # source://racc//racc/grammar.rb#76
  def symbols; end

  # Returns the value of attribute symboltable.
  #
  # source://racc//racc/grammar.rb#37
  def symboltable; end

  # source://racc//racc/grammar.rb#62
  def to_s; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#84
  def useless_nonterminal_exist?; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#100
  def useless_rule_exist?; end

  # source://racc//racc/grammar.rb#156
  def write_log(path); end

  private

  # source://racc//racc/grammar.rb#504
  def _compute_expand(t, set, lock); end

  # source://racc//racc/grammar.rb#430
  def add_start_rule; end

  # source://racc//racc/grammar.rb#537
  def check_rules_nullable(rules); end

  # source://racc//racc/grammar.rb#578
  def check_rules_useless(rules); end

  # source://racc//racc/grammar.rb#550
  def check_symbols_nullable(symbols); end

  # source://racc//racc/grammar.rb#591
  def check_symbols_useless(s); end

  # Sym#expand
  #
  # source://racc//racc/grammar.rb#498
  def compute_expand(t); end

  # Rule#hash
  #
  # source://racc//racc/grammar.rb#449
  def compute_hash; end

  # Sym#heads
  #
  # source://racc//racc/grammar.rb#458
  def compute_heads; end

  # Sym#locate
  #
  # source://racc//racc/grammar.rb#483
  def compute_locate; end

  # Sym#nullable?, Rule#nullable?
  #
  # source://racc//racc/grammar.rb#524
  def compute_nullable; end

  # Sym#self_null?
  #
  # source://racc//racc/grammar.rb#472
  def compute_nullable_0; end

  # Sym#useless?, Rule#useless?
  # FIXME: what means "useless"?
  #
  # source://racc//racc/grammar.rb#564
  def compute_useless; end

  # Sym#terminal?
  #
  # source://racc//racc/grammar.rb#465
  def determine_terminals; end

  # Rule#ident
  # LocationPointer#ident
  #
  # source://racc//racc/grammar.rb#442
  def fix_ident; end

  class << self
    # Dynamic Generation Interface
    #
    # source://racc//racc/grammar.rb#201
...
class Racc::Grammar::DefinitionEnv
  ...
  #
  # source://racc//racc/grammar.rb#208
  def initialize; end

  # source://racc//racc/grammar.rb#282
  def _(&block); end

  # source://racc//racc/grammar.rb#242
  def _add(target, x); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#262
  def _added?(sym); end

  # source://racc//racc/grammar.rb#258
  def _delayed_add(rule); end

  # source://racc//racc/grammar.rb#321
  def _intern(x); end

  # source://racc//racc/grammar.rb#282
  def action(&block); end

  # source://racc//racc/grammar.rb#266
  def flush_delayed; end

  # source://racc//racc/grammar.rb#214
  def grammar; end

  # source://racc//racc/grammar.rb#296
  def many(sym, &block); end

  # source://racc//racc/grammar.rb#303
  def many1(sym, &block); end

  # source://racc//racc/grammar.rb#231
  def method_missing(mid, *args, &block); end

  # source://racc//racc/grammar.rb#278
  def null(&block); end

  # source://racc//racc/grammar.rb#290
  def option(sym, default = T.unsafe(nil), &block); end

  # source://racc//racc/grammar.rb#225
  def precedence_table(&block); end

  # source://racc//racc/grammar.rb#310
  def separated_by(sep, sym, &block); end

  # source://racc//racc/grammar.rb#314
  def separated_by1(sep, sym, &block); end

  # source://racc//racc/grammar.rb#274
  def seq(*list, &block); end

  private

  # source://racc//racc/grammar.rb#334
  def _defmetasyntax(type, id, action, &block); end

  # source://racc//racc/grammar.rb#345
  def _register(target_name); end

  # source://racc//racc/grammar.rb#356
...
class Racc::Grammar::PrecedenceDefinitionEnv
  ...
  #
  # source://racc//racc/grammar.rb#366
  def initialize(g); end

  # source://racc//racc/grammar.rb#375
  def higher; end

  # source://racc//racc/grammar.rb#392
  def left(*syms); end

  # source://racc//racc/grammar.rb#382
  def lower; end

  # source://racc//racc/grammar.rb#400
  def nonassoc(*syms); end

  # Returns the value of attribute reverse.
  #
  # source://racc//racc/grammar.rb#373
  def reverse; end

  # source://racc//racc/grammar.rb#396
  def right(*syms); end
end
...
class Racc::ISet
  ...
  #
  # source://racc//racc/iset.rb#18
  def initialize(a = T.unsafe(nil)); end

  # source://racc//racc/iset.rb#28
  def [](key); end

  # source://racc//racc/iset.rb#32
  def []=(key, val); end

  # source://racc//racc/iset.rb#24
  def add(i); end

  # source://racc//racc/iset.rb#82
  def clear; end

  # source://racc//racc/iset.rb#54
  def delete(key); end

  # source://racc//racc/iset.rb#86
  def dup; end

  # source://racc//racc/iset.rb#60
  def each(&block); end

  # @return [Boolean]
  #
  # source://racc//racc/iset.rb#78
  def empty?; end

  # source://racc//racc/iset.rb#28
  def include?(key); end

  # source://racc//racc/iset.rb#68
  def inspect; end
  ...
  #
  # source://racc//racc/iset.rb#22
  def set; end

  # source://racc//racc/iset.rb#74
  def size; end

  # source://racc//racc/iset.rb#64
  def to_a; end

  # source://racc//racc/iset.rb#68
  def to_s; end

  # source://racc//racc/iset.rb#39
  def update(other); end

  # source://racc//racc/iset.rb#49
  def update_a(a); end
end
...
class Racc::Item
  ...
  #
  # source://racc//racc/state.rb#788
  def initialize(rule, la); end

  # source://racc//racc/state.rb#796
  def each_la(tbl); end

  # Returns the value of attribute la.
  #
  # source://racc//racc/state.rb#794
  def la; end

  # Returns the value of attribute rule.
  #
  # source://racc//racc/state.rb#793
  def rule; end
end
...
class Racc::LocationPointer
  ...
  #
  # source://racc//racc/grammar.rb#814
  def initialize(rule, i, sym); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#840
  def ==(ot); end

  # source://racc//racc/grammar.rb#856
  def before(len); end

  # Returns the value of attribute symbol.
  #
  # source://racc//racc/grammar.rb#824
  def dereference; end
  ...
  # Returns the value of attribute ident.
  #
  # source://racc//racc/grammar.rb#828
  def hash; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#846
  def head?; end
  ...
  # source://racc//racc/grammar.rb#850
  def increment; end

  # Returns the value of attribute index.
  #
  # source://racc//racc/grammar.rb#823
  def index; end

  # source://racc//racc/grammar.rb#833
  def inspect; end
  ...
  #
  # source://racc//racc/grammar.rb#830
  def reduce; end
  ...
  # Returns the value of attribute rule.
  #
  # source://racc//racc/grammar.rb#822
  def rule; end
  ...
  # source://racc//racc/grammar.rb#862
  def ptr_bug!; end
end
...
class Racc::LogFileGenerator
  ...
  #
  # source://racc//racc/logfilegenerator.rb#17
  def initialize(states, debug_flags = T.unsafe(nil)); end

  # source://racc//racc/logfilegenerator.rb#92
  def action_out(f, state); end

  # source://racc//racc/logfilegenerator.rb#133
  def outact(f, t, act); end

  # source://racc//racc/logfilegenerator.rb#23
  def output(out); end

  # Warnings
  #
  # source://racc//racc/logfilegenerator.rb#35
  def output_conflict(out); end

  # Rules
  #
  # source://racc//racc/logfilegenerator.rb#170
  def output_rule(out); end

  # States
  #
  # source://racc//racc/logfilegenerator.rb#66
  def output_state(out); end

  # Tokens
  #
  # source://racc//racc/logfilegenerator.rb#184
  def output_token(out); end

  # source://racc//racc/logfilegenerator.rb#48
  def output_useless(out); end

  # source://racc//racc/logfilegenerator.rb#158
  def outrrconf(f, confs); end

  # source://racc//racc/logfilegenerator.rb#150
  def outsrconf(f, confs); end

  # source://racc//racc/logfilegenerator.rb#82
  def pointer_out(out, ptr); end

  # source://racc//racc/logfilegenerator.rb#206
...
class Racc::OrMark
  ...
  #
  # source://racc//racc/grammar.rb#776
  def initialize(lineno); end

  # source://racc//racc/grammar.rb#780
  def inspect; end

  # Returns the value of attribute lineno.
  #
  # source://racc//racc/grammar.rb#786
  def lineno; end
...
class Racc::ParserClassGenerator
  ...
  #
  # source://racc//racc/statetransitiontable.rb#263
  def initialize(states); end

  # source://racc//racc/statetransitiontable.rb#268
  def generate; end

  private

  # source://racc//racc/statetransitiontable.rb#293
...
class Racc::Prec
  ...
  #
  # source://racc//racc/grammar.rb#791
  def initialize(symbol, lineno); end

  # source://racc//racc/grammar.rb#796
  def inspect; end

  # Returns the value of attribute lineno.
  #
  # source://racc//racc/grammar.rb#803
  def lineno; end
  ...
  # Returns the value of attribute symbol.
  #
  # source://racc//racc/grammar.rb#802
  def symbol; end
end
...
class Racc::RRconflict
  ...
  #
  # source://racc//racc/state.rb#954
  def initialize(sid, high, low, tok); end

  # Returns the value of attribute high_prec.
  #
  # source://racc//racc/state.rb#962
  def high_prec; end

  # Returns the value of attribute low_prec.
  #
  # source://racc//racc/state.rb#963
  def low_prec; end

  # Returns the value of attribute stateid.
  #
  # source://racc//racc/state.rb#961
  def stateid; end

  # source://racc//racc/state.rb#966
  def to_s; end

  # Returns the value of attribute token.
  #
  # source://racc//racc/state.rb#964
  def token; end
end
...
class Racc::Reduce
  ...
  #
  # source://racc//racc/state.rb#898
  def initialize(rule); end

  # source://racc//racc/state.rb#918
  def decref; end

  # source://racc//racc/state.rb#914
  def incref; end

  # source://racc//racc/state.rb#910
  def inspect; end

  # Returns the value of attribute refn.
  #
  # source://racc//racc/state.rb#904
  def refn; end

  # Returns the value of attribute rule.
  #
  # source://racc//racc/state.rb#903
  def rule; end

  # source://racc//racc/state.rb#906
  def ruleid; end
end
...
class Racc::Rule
  ...
  #
  # source://racc//racc/grammar.rb#608
  def initialize(target, syms, act); end

  # source://racc//racc/grammar.rb#687
  def ==(other); end

  # source://racc//racc/grammar.rb#691
  def [](idx); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#707
  def accept?; end

  # Returns the value of attribute action.
  #
  # source://racc//racc/grammar.rb#625
  def action; end

  # source://racc//racc/grammar.rb#715
  def each(&block); end

  # @yield [_self]
  # @yieldparam _self [Racc::Rule] the object that the method was called on
  #
  # source://racc//racc/grammar.rb#636
  def each_rule(&block); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#699
  def empty?; end

  # Returns the value of attribute hash.
  #
  # source://racc//racc/grammar.rb#643
  def hash; end

  # source://racc//racc/grammar.rb#646
  def hash=(n); end

  # Returns the value of attribute ident.
  #
  # source://racc//racc/grammar.rb#641
  def ident; end
  ...
  # source://racc//racc/grammar.rb#683
  def inspect; end

  # source://racc//racc/grammar.rb#678
  def null=(n); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#677
  def nullable?; end

  # source://racc//racc/grammar.rb#664
  def prec(sym, &block); end

  # source://racc//racc/grammar.rb#656
  def precedence; end

  # source://racc//racc/grammar.rb#660
  def precedence=(sym); end

  # Returns the value of attribute ptrs.
  #
  # source://racc//racc/grammar.rb#644
  def ptrs; end

  # source://racc//racc/grammar.rb#719
  def replace(src, dest); end

  # source://racc//racc/grammar.rb#632
  def rule; end

  # source://racc//racc/grammar.rb#695
  def size; end

  # Returns the value of attribute specified_prec.
  #
  # source://racc//racc/grammar.rb#675
  ...
  #
  # source://racc//racc/grammar.rb#624
  def symbols; end

  # Returns the value of attribute target.
  #
  # source://racc//racc/grammar.rb#623
  def target; end
  ...
  # source://racc//racc/grammar.rb#703
  def to_s; end

  # source://racc//racc/grammar.rb#681
  def useless=(u); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#680
  def useless?; end

  # source://racc//racc/grammar.rb#627
  def |(x); end
end
...
class Racc::SRconflict
  ...
  #
  # source://racc//racc/state.rb#937
  def initialize(sid, shift, reduce); end

  # Returns the value of attribute reduce.
  #
  # source://racc//racc/state.rb#945
  def reduce; end

  # Returns the value of attribute shift.
  #
  # source://racc//racc/state.rb#944
  def shift; end

  # Returns the value of attribute stateid.
  #
  # source://racc//racc/state.rb#943
  def stateid; end

  # source://racc//racc/state.rb#947
  def to_s; end
end
...
class Racc::Shift
  ...
  #
  # source://racc//racc/state.rb#881
  def initialize(goto); end

  # source://racc//racc/state.rb#887
  def goto_id; end

  # Returns the value of attribute goto_state.
  #
  # source://racc//racc/state.rb#885
  def goto_state; end

  # source://racc//racc/state.rb#891
  def inspect; end
end
...
class Racc::SourceText
  ...
  #
  # source://racc//racc/sourcetext.rb#16
  def initialize(text, filename, lineno); end

  # Returns the value of attribute filename.
  #
  # source://racc//racc/sourcetext.rb#23
  def filename; end

  # Returns the value of attribute lineno.
  #
  # source://racc//racc/sourcetext.rb#24
  def lineno; end

  # source://racc//racc/sourcetext.rb#30
  def location; end

  # Returns the value of attribute text.
  #
  # source://racc//racc/sourcetext.rb#22
  def text; end

  # source://racc//racc/sourcetext.rb#26
  def to_s; end
end
...
class Racc::State
  ...
  #
  # source://racc//racc/state.rb#609
  def initialize(ident, core); end

  # source://racc//racc/state.rb#650
  def ==(oth); end

  # Returns the value of attribute action.
  #
  # source://racc//racc/state.rb#638
  def action; end

  # source://racc//racc/state.rb#667
  def check_la(la_rules); end

  # Returns the value of attribute closure.
  #
  # source://racc//racc/state.rb#629
  def closure; end

  # @return [Boolean]
  #
  # source://racc//racc/state.rb#701
  def conflict?; end

  # Returns the value of attribute core.
  #
  # source://racc//racc/state.rb#628
  def core; end

  # default action
  #
  # source://racc//racc/state.rb#639
  def defact; end
  ...
  #
  # source://racc//racc/state.rb#631
  def goto_table; end

  # Returns the value of attribute gotos.
  #
  # source://racc//racc/state.rb#632
  def gotos; end

  # Returns the value of attribute ident.
  #
  # source://racc//racc/state.rb#624
  def hash; end
  ...
  # source://racc//racc/state.rb#644
  def inspect; end

  # source://racc//racc/state.rb#718
  def la=(la); end

  # source://racc//racc/state.rb#656
  def make_closure(core); end

  # source://racc//racc/state.rb#754
  def n_rrconflicts; end

  # source://racc//racc/state.rb#750
  def n_srconflicts; end

  # Returns the value of attribute ritems.
  #
  # source://racc//racc/state.rb#635
  def ritems; end

  # source://racc//racc/state.rb#728
  def rr_conflict(high, low, ctok); end

  # Returns the value of attribute rrconf.
  #
  # source://racc//racc/state.rb#641
  def rrconf; end

  # source://racc//racc/state.rb#705
  def rruleid(rule); end

  # Returns the value of attribute rrules.
  #
  # source://racc//racc/state.rb#636
  def rrules; end

  # source://racc//racc/state.rb#739
  def sr_conflict(shift, reduce); end

  # Returns the value of attribute srconf.
  #
  # source://racc//racc/state.rb#642
  def srconf; end
...
class Racc::StateTransitionTable < ::Struct
  ...
  #
  # source://racc//racc/statetransitiontable.rb#38
  def initialize(states); end
  ...
  #
  # source://racc//racc/statetransitiontable.rb#47
  def grammar; end
  ...
  # source://racc//racc/statetransitiontable.rb#49
  def parser_class; end
  ...
  #
  # source://racc//racc/statetransitiontable.rb#46
  def states; end
  ...
  # source://racc//racc/statetransitiontable.rb#53
  ...
  class << self
    ...
    # source://racc//racc/statetransitiontable.rb#34
...
class Racc::StateTransitionTableGenerator
  ...
  #
  # source://racc//racc/statetransitiontable.rb#65
  def initialize(states); end

  # source://racc//racc/statetransitiontable.rb#247
  def act2actid(act); end

  # source://racc//racc/statetransitiontable.rb#169
  def addent(all, arr, chkval, ptr); end

  # source://racc//racc/statetransitiontable.rb#105
  def gen_action_tables(t, states); end

  # source://racc//racc/statetransitiontable.rb#127
  def gen_goto_tables(t, grammar); end

  # source://racc//racc/statetransitiontable.rb#70
  def generate; end

  # source://racc//racc/statetransitiontable.rb#191
  def mkmapexp(arr); end

  # source://racc//racc/statetransitiontable.rb#83
  def reduce_table(grammar); end

  # source://racc//racc/statetransitiontable.rb#222
  def set_table(entries, dummy, tbl, chk, ptr); end

  # source://racc//racc/statetransitiontable.rb#97
  def token_table(grammar); end
end

# source://racc//racc/statetransitiontable.rb#185
...
class Racc::States
  ...
  #
  # source://racc//racc/state.rb#25
  def initialize(grammar, debug_flags = T.unsafe(nil)); end

  # source://racc//racc/state.rb#51
  def [](i); end

  # Returns the value of attribute actions.
  #
  # source://racc//racc/state.rb#39
  def actions; end

  # source://racc//racc/state.rb#196
  def dfa; end

  # source://racc//racc/state.rb#55
  def each(&block); end

  # source://racc//racc/state.rb#61
  def each_index(&block); end
  ...
  # Returns the value of attribute grammar.
  #
  # source://racc//racc/state.rb#38
  def grammar; end

  # source://racc//racc/state.rb#45
  def inspect; end

  # source://racc//racc/state.rb#88
  def n_rrconflicts; end

  # source://racc//racc/state.rb#80
  def n_srconflicts; end

  # source://racc//racc/state.rb#102
  def nfa; end
  ...
  # @return [Boolean]
  #
  # source://racc//racc/state.rb#71
  def should_report_srconflict?; end

  # source://racc//racc/state.rb#41
  def size; end

  # @return [Boolean]
  #
  # source://racc//racc/state.rb#76
  def srconflict_exist?; end

  # source://racc//racc/state.rb#92
  def state_transition_table; end
  ...
  # source://racc//racc/state.rb#317
  def addrel(tbl, i, item); end

  # source://racc//racc/state.rb#154
  def addsym(table, sym, ptr); end

  # source://racc//racc/state.rb#586
  def check_useless; end

  # source://racc//racc/state.rb#206
  def compute_dfa; end

  # source://racc//racc/state.rb#111
  def compute_nfa; end

  # source://racc//racc/state.rb#161
  def core_to_state(core); end

  # source://racc//racc/state.rb#313
  def create_tmap(size); end

  # source://racc//racc/state.rb#348
  def digraph(map, relation); end

  # source://racc//racc/state.rb#523
  def do_resolve_sr(stok, rtok); end

  # source://racc//racc/state.rb#422
  def each_t(tbl, set); end

  # source://racc//racc/state.rb#186
  def fingerprint(arr); end

  # source://racc//racc/state.rb#125
  def generate_states(state); end

  # source://racc//racc/state.rb#219
  def lookahead; end

  # source://racc//racc/state.rb#564
  def pack(state); end

  # for debug
  #
  # source://racc//racc/state.rb#390
  def print_atab(idx, tab); end

  # source://racc//racc/state.rb#397
  def print_tab(idx, rel, tab); end

  # for debug
  #
  # source://racc//racc/state.rb#407
  def print_tab_i(idx, rel, tab, i); end

  # for debug
  #
  # source://racc//racc/state.rb#415
  def printb(i); end

  # source://racc//racc/state.rb#325
  def record_path(begst, rule); end

  # resolve
  #
  # source://racc//racc/state.rb#436
  def resolve(state); end

  # source://racc//racc/state.rb#453
  def resolve_rr(state, r); end

  # source://racc//racc/state.rb#472
  def resolve_sr(state, s); end

  # complete
  #
  # source://racc//racc/state.rb#553
  def set_accept; end

  # source://racc//racc/state.rb#336
  def transpose(rel); end

  # source://racc//racc/state.rb#361
  def traverse(i, index, vertices, map, relation); end
end

# source://racc//racc/state.rb#517
...
class Racc::Sym
  ...
  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1031
  def dummy?; end

  # Returns the value of attribute expand.
  #
  # source://racc//racc/grammar.rb#1105
  def expand; end
  ...
  # Returns the value of attribute ident.
  #
  # source://racc//racc/grammar.rb#1025
  def hash; end

  # cache
  #
  # source://racc//racc/grammar.rb#1088
  def heads; end
  ...
  # source://racc//racc/grammar.rb#1070
  def inspect; end

  # Returns the value of attribute locate.
  #
  # source://racc//racc/grammar.rb#1089
  def locate; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1039
  def nonterminal?; end

  # source://racc//racc/grammar.rb#1101
  def null=(n); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1097
  def nullable?; end

  # Returns the value of attribute precedence.
  #
  # source://racc//racc/grammar.rb#1067
  def precedence; end
  ...
  # source://racc//racc/grammar.rb#1080
  def rule; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1091
  def self_null?; end

  # source://racc//racc/grammar.rb#1061
  def serialize; end
  ...
  #
  # source://racc//racc/grammar.rb#1065
  def serialized=(_arg0); end

  # source://racc//racc/grammar.rb#1049
  def should_terminal; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1053
  def should_terminal?; end
  ...
  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1057
  def string_symbol?; end

  # source://racc//racc/grammar.rb#1043
  def term=(t); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1035
  def terminal?; end

  # source://racc//racc/grammar.rb#1070
  def to_s; end

  # source://racc//racc/grammar.rb#1112
  def useless=(f); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#1108
  def useless?; end

  # Returns the value of attribute value.
  #
  # source://racc//racc/grammar.rb#1029
  def value; end

  # source://racc//racc/grammar.rb#1076
  def |(x); end

  class << self
    # source://racc//racc/grammar.rb#1013
...
class Racc::SymbolTable
  ...
  #
  # source://racc//racc/grammar.rb#873
  def initialize; end

  # source://racc//racc/grammar.rb#885
  def [](id); end

  # Returns the value of attribute anchor.
  #
  # source://racc//racc/grammar.rb#882
  def anchor; end

  # source://racc//racc/grammar.rb#901
  def delete(sym); end

  # Returns the value of attribute dummy.
  #
  # source://racc//racc/grammar.rb#881
  def dummy; end

  # source://racc//racc/grammar.rb#912
  def each(&block); end

  # source://racc//racc/grammar.rb#928
  def each_nonterminal(&block); end

  # source://racc//racc/grammar.rb#920
  def each_terminal(&block); end

  # Returns the value of attribute error.
  #
  # source://racc//racc/grammar.rb#883
  def error; end

  # source://racc//racc/grammar.rb#932
  def fix; end

  # source://racc//racc/grammar.rb#889
  def intern(val, dummy = T.unsafe(nil)); end

  # source://racc//racc/grammar.rb#924
  def nonterminals; end

  # Returns the value of attribute nt_base.
  #
  # source://racc//racc/grammar.rb#906
  def nt_base; end

  # source://racc//racc/grammar.rb#908
  def nt_max; end

  # Returns the value of attribute symbols.
  #
  # source://racc//racc/grammar.rb#898
  def symbols; end

  # source://racc//racc/grammar.rb#916
  ...
  # source://racc//racc/grammar.rb#950
  def check_terminals; end

  # source://racc//racc/grammar.rb#944
  def fix_ident; end
end
...
class Racc::UserAction
  ...
  #
  # source://racc//racc/grammar.rb#746
  def initialize(src, proc); end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#762
  def empty?; end

  # source://racc//racc/grammar.rb#766
  def inspect; end
  ...
  #
  # source://racc//racc/grammar.rb#752
  def proc; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#758
  def proc?; end

  # Returns the value of attribute source.
  #
  # source://racc//racc/grammar.rb#751
  def source; end

  # @return [Boolean]
  #
  # source://racc//racc/grammar.rb#754
  def source?; end

  class << self
    # source://racc//racc/grammar.rb#740
    def empty; end

    # source://racc//racc/grammar.rb#733
    def proc(pr = T.unsafe(nil), &block); end

    # source://racc//racc/grammar.rb#729
