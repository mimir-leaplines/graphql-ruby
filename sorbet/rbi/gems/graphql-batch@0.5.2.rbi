...
module GraphQL
  class << self
    # source://graphql/2.0.25/lib/graphql.rb#35
    def default_parser; end

    # source://graphql/2.0.25/lib/graphql.rb#39
    def default_parser=(_arg0); end

    # source://graphql/2.0.25/lib/graphql.rb#45
    def parse(graphql_string, trace: T.unsafe(nil)); end

    # source://graphql/2.0.25/lib/graphql.rb#52
    def parse_file(filename); end

    # source://graphql/2.0.25/lib/graphql.rb#62
    def parse_with_racc(string, filename: T.unsafe(nil), trace: T.unsafe(nil)); end

    # source://graphql/2.0.25/lib/graphql.rb#58
    def scan(graphql_string); end

    # source://graphql/2.0.25/lib/graphql.rb#66
...
class GraphQL::Batch::Loader
  ...
  # For Promise#sync
  #
  # source://graphql-batch//lib/graphql/batch/loader.rb#76
  def wait; end
  ...
  #
  # source://graphql-batch//lib/graphql/batch/loader.rb#122
  def cache_key(load_key); end

  # Fulfill the key with provided value, for use in #perform
  #
  # source://graphql-batch//lib/graphql/batch/loader.rb#91
  ...
  # @return [Boolean]
  #
  # source://graphql-batch//lib/graphql/batch/loader.rb#104
  ...
  #
  # source://graphql-batch//lib/graphql/batch/loader.rb#117
  ...
  # source://graphql-batch//lib/graphql/batch/loader.rb#136
  def cache; end

  # source://graphql-batch//lib/graphql/batch/loader.rb#156
  def check_for_broken_promises(load_keys); end

  # source://graphql-batch//lib/graphql/batch/loader.rb#128
  def finish_resolve(key); end

  # source://graphql-batch//lib/graphql/batch/loader.rb#144
  def promise_for(load_key); end

  # source://graphql-batch//lib/graphql/batch/loader.rb#140
  def queue; end

  # source://graphql-batch//lib/graphql/batch/loader.rb#148
