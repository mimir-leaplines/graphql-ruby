...
# source://colorator//lib/colorator.rb#3
module Colorator
  private
  ...
  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#38
  def ansi_jump(str, num); end

  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#54
  ...
  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#74
  def clear_screen(str = T.unsafe(nil)); end

  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#82
  ...
  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#26
  def has_ansi?(str); end

  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#46
  ...
  # --------------------------------------------------------------------------
  #
  # source://colorator//lib/colorator.rb#64
  ...
  class << self
    ...
    # source://colorator//lib/colorator.rb#89
    def black(str); end
...
# source://colorator//lib/colorator.rb#10
Colorator::ANSI_COLORS = T.let(T.unsafe(nil), Hash)

# --------------------------------------------------------------------------
#
# source://colorator//lib/colorator.rb#9
Colorator::ANSI_MATCHR = T.let(T.unsafe(nil), Regexp)

# --------------------------------------------------------------------------
#
# source://colorator//lib/colorator.rb#106
Colorator::CORE_METHODS = T.let(T.unsafe(nil), Array)

# source://colorator//lib/colorator.rb#5
